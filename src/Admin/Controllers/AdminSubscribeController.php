    ...
    public function index()
    {
        ...
        foreach ($dataTmp as $key => $row) {
            $dataTr[$row['id']] = [
                ...
                'action' => '
                    <a href="' . gc_route_admin('admin_subscribe.edit', ['id' => $row['id'] ? $row['id'] : 'not-found-id']) . '"><span title="' . gc_language_render('action.edit') . '" type="button" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
        ...
        $data['topMenuRight'][] = '
                ...
                <div class="input-group input-group" style="width: 350px;">
                    ...
                    <input type="text" name="keyword" class="form-control rounded-0 float-right" placeholder="' . gc_language_render('subscribe.admin.search_place') . '" value="' . $keyword . '">
