...
class AdminStoreLinkController extends RootAdminController
{
    ...
    public function index()
    {
        ...
        foreach ($dataTmp as $key => $row) {
            ...
            $dataMap['action'] = '<a href="' . gc_route_admin('admin_store_link.edit', ['id' => $row['id'] ? $row['id'] : 'not-found-id']) . '"><span title="' . gc_language_render('action.edit') . '" type="button" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
