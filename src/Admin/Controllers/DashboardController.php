...
class DashboardController extends RootAdminController
{
    ...
    public function index(Request $request)
    {
        ...
        if (!\Admin::user()->checkUrlAllowAccess(route('admin.home'))) {
            $data['title'] = gc_language_render('admin.dashboard');
        ...
        if (config('admin.admin_dashboard.pie_chart_type') == 'country') {
            ...
            $pieChartTitle = gc_language_render('admin.chart.static_country');
            //End countries
        }
        ...
        if (config('admin.admin_dashboard.pie_chart_type') == 'device') {
            ...
            $pieChartTitle = gc_language_render('admin.chart.static_device');
        ...
        if (config('admin.admin_dashboard.pie_chart_type') == 'order') {
            ...
            $pieChartTitle = gc_language_render('admin.chart.static_count_order');
    ...
    {
        $data = [
            'title' => gc_language_render('admin.data_not_found'),
            'icon' => '',
            'url' => session('url'),
        ];
    ...
    {
        $data = [
            'title' => gc_language_render('admin.deny'),
            'icon' => '',
