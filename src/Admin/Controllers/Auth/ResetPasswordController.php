...
class ResetPasswordController extends RootAdminController
{
    ...
    {
        if (admin()->user()) {
            return redirect(gc_route_admin('admin.home'));
        }
        $data = [
                'title'       => gc_language_render('admin.password_reset'),
                'token'       => $token,
                'breadcrumbs' => [
                    ['url'    => '', 'title' => gc_language_render('admin.password_reset')],
                ],
            ];
    ...
    public function redirectPath() {
        return gc_route_admin('admin.home');
    }
