...
class AdminStoreMaintainController extends RootAdminController
{
    ...
    public function index()
    {
        ...
        $data = [
            'title' => gc_language_render('admin.maintain.title'),
            'subTitle' => '',
            'title_description' => '',
            'icon' => 'fa fa-edit',
            'languages' => $this->languages,
            'maintain' => $maintain,
            'url_action' => gc_route_admin('admin_store_maintain.index'),
        ];
...
//
        return redirect()->route('admin_store_maintain.index')->with('success', gc_language_render('action.edit_success'));
    }
}
