...
class AdminNewsController extends RootAdminController
{
    ...
    public function index()
    {
        ...
        foreach ($dataTmp as $key => $row) {
            ...
            $dataMap['action'] = '<a href="' . gc_route_admin('admin_news.edit', ['id' => $row['id'] ? $row['id'] : 'not-found-id']) . '"><span title="' . gc_language_render('action.edit') . '" type="button" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
            ...
            <a target=_new href="' . gc_route('news.detail', ['alias' => $row['alias']]) . '"><span title="Link" type="button" class="btn btn-flat btn-sm btn-warning"><i class="fas fa-external-link-alt"></i></a>
            ';
        ...
        //menuRight
        $data['menuRight'][] = '<a href="' . gc_route_admin('admin_news.create') . '" class="btn  btn-success  btn-flat" title="New" id="button_create_new">
