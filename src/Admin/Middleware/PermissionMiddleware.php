...
use Glumbo\Gracart\Admin\Permission;
...
class PermissionMiddleware
{
    ...
    protected function shouldPassThrough($request)
    {
        ...
        $exceptsPAth = [
            GC_ADMIN_PREFIX . '/auth/login',
            GC_ADMIN_PREFIX . '/auth/logout',
        ];
    ...
    */
    ...
    {
        return [
            GC_ADMIN_PREFIX . '/uploads/delete',
            GC_ADMIN_PREFIX . '/uploads/newfolder',
            GC_ADMIN_PREFIX . '/uploads/domove',
            GC_ADMIN_PREFIX . '/uploads/rename',
            GC_ADMIN_PREFIX . '/uploads/resize',
            GC_ADMIN_PREFIX . '/uploads/doresize',
            GC_ADMIN_PREFIX . '/uploads/cropimage',
            GC_ADMIN_PREFIX . '/uploads/crop',
            GC_ADMIN_PREFIX . '/uploads/move',
        ];
    }
}
