...
@section('main')
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              <span class="info-box-icon bg-green"><i class="ion ion-iograkan-outline"></i></span>
  
              <div class="info-box-content">
                <span class="info-box-text">{{ gc_language_render('admin.dashboard.total_order') }}</span>
                <span class="info-box-number">{{ number_format($totalOrder) }}</span>
                <a href="{{ gc_route_admin('admin_order.index') }}" class="small-box-footer">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">{{ gc_language_render('admin.dashboard.total_product') }}</span>
                <span class="info-box-number">{{ number_format($totalProduct) }}</span>
                <a href="{{ gc_route_admin('admin_product.index') }}" class="small-box-footer">
                    {{ gc_language_render('action.view_more') }}&nbsp;
                    <i class="fa fa-arrow-circle-right"></i>
                </a>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">{{ gc_language_render('admin.dashboard.total_customer') }}</span>
                <span class="info-box-number">{{ number_format($totalCustomer) }}</span>
                <a href="{{ gc_route_admin('admin_customer.index') }}" class="small-box-footer">
                    {{ gc_language_render('action.view_more') }}&nbsp;
                    <i class="fa fa-arrow-circle-right"></i>
                </a>
              </div>
                  ...
                  <table class="table m-0">
                    ...
                    <tbody>
                      ...
                      @foreach ($topCustomer as $customer)
                        <tr>
                          <td><a href="{{ gc_route_admin('admin_customer.edit',['id'=>$customer->id]) }}">{{ $customer->email }}</a></td>
                          <td>{{ $customer->name }}</td>
