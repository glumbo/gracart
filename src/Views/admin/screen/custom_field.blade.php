      ...
      <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main">
        <div class="card-body">
          ...
          <div class="form-group row {{ $errors->has('name') ? ' text-red' : '' }}">
            <label for="name" class="col-sm-2 col-form-label">{{ gc_language_render('admin.custom_field.name') }}</label>
            <div class="col-sm-10 ">
          ...
          <div class="form-group row {{ $errors->has('code') ? ' text-red' : '' }}">
            <label for="code" class="col-sm-2 col-form-label">{!! gc_language_render('admin.custom_field.code') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
          ...
          <div class="form-group row {{ $errors->has('type') ? ' text-red' : '' }}">
            <label for="type" class="col-sm-2 col-form-label">{!! gc_language_render('admin.custom_field.type') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
          ...
          <div class="form-group row {{ $errors->has('option') ? ' text-red' : '' }}">
            <label for="option" class="col-sm-2 col-form-label">{!! gc_language_render('admin.custom_field.option') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
          ...
          <div class="form-group row {{ $errors->has('default') ? ' text-red' : '' }}">
            <label for="default" class="col-sm-2 col-form-label">{!! gc_language_render('admin.custom_field.default') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
              ...
              @else
              <span class="text-sm">
                <i class="fa fa-info-circle"></i> {!! gc_language_render('admin.custom_field.default_help') !!}
              </span>
              @endif
          ...
          <div class="form-group row {{ $errors->has('required') ? ' text-red' : '' }}">
            <label for="required" class="col-sm-2 col-form-label">{!! gc_language_render('admin.custom_field.required') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
                <input class="checkbox" type="checkbox" id="required" name="required"
                    class="form-control input {{ $errors->has('required') ? ' is-invalid' : '' }}" placeholder="" {!!
          ...
          <div class="form-group row {{ $errors->has('status') ? ' text-red' : '' }}">
            <label for="status" class="col-sm-2 col-form-label">{!! gc_language_render('admin.custom_field.status') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
