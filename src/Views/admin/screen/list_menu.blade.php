                ...
                <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main"  enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group row {{ $errors->has('parent_id') ? ' text-red' : '' }}">
                        <label for="parent_id" class="col-sm-2 col-form-label">{{ gc_language_render('admin.menu.parent') }}</label>
                        <div class="col-sm-10 ">
                      ...
                      <div class="form-group row {{ $errors->has('title') ? ' text-red' : '' }}">
                        <label for="title" class="col-sm-2 col-form-label">{{ gc_language_render('admin.menu.title') }}</label>
                        <div class="col-sm-10 ">
                      ...
                      <div class="form-group row {{ $errors->has('icon') ? ' text-red' : '' }}">
                        <label for="icon" class="col-sm-2 col-form-label">{{ gc_language_render('admin.menu.icon') }}</label>
                        <div class="col-sm-10 ">
                          <div class="input-group mb-3">
                            <div class="input-group-prepend">
                      ...
                      <div class="form-group row {{ $errors->has('uri') ? ' text-red' : '' }}">
                        <label for="uri" class="col-sm-2 col-form-label">{{ gc_language_render('admin.menu.uri') }}</label>
                        <div class="col-sm-10 ">
                          <div class="input-group mb-3">
                            <div class="input-group-prepend">
                              <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                      ...
                      <div class="form-group row {{ $errors->has('sort') ? ' text-red' : '' }}">
                        <label for="sort" class="col-sm-2 col-form-label">{{ gc_language_render('admin.menu.sort') }}</label>
                        <div class="col-sm-10 ">
                          <div class="input-group mb-3">
                            <div class="input-group-prepend">
                              <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
...
@push('styles')
<!-- Ediable -->
<link rel="stylesheet" href="{{ gc_file('admin/plugin/nestable/jquery.nestable.min.css')}}">
<link rel="stylesheet" href="{{ gc_file('admin/plugin/iconpicker/fontawesome-iconpicker.min.css')}}">
@endpush

@push('scripts')
<!-- Ediable -->

<script src="{{ gc_file('admin/plugin/nestable/jquery.nestable.min.js')}}"></script>
<script src="{{ gc_file('admin/plugin/iconpicker/fontawesome-iconpicker.min.js')}}"></script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.error == 1){
                      ...
                      window.location.replace('{{ gc_route_admin('admin_menu.index') }}');
                    }
...
$('.menu-sort-save').click(function () {
    ...
    $.ajax({
      url: '{{ gc_route_admin('admin_menu.update_sort') }}',
      type: 'POST',
      dataType: 'json',
      data: {
        _token: '{{ csrf_token() }}',
