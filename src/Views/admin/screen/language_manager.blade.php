          ...
          <div class="box-body table-responsive">
            <section id="pjax-container" class="table-list">
                <div class="card-body table-responsivep-0" >
                  <form action="{{ gc_route_admin('admin_language_manager.index') }}" method="GET">
                        ...
                        <div class="input-group float-start ml-1">
                          ...
                          <div class="btn-group">
                            <select class="form-control select2" name="lang">
                              <option value="">{{ gc_language_render('admin.language.select_lang') }}</option>
                              @php
                                  $lang = $lang ?? 'en';
                              @endphp
                          ...
                          &nbsp; 
                          <div class="btn-group">
                            <a href="{{ gc_route_admin('admin_language_manager.add') }}"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i></button></a>
                        </div>
                        </div>
                      </td>
                    </tr>
                  ...
                  <table class="table table-hover box-body text-wrap table-bordered">
                      <thead>
                         <tr>
                           <th>{{ gc_language_render('admin.language_manager.position') }}</th>
                           <th>{{ gc_language_render('admin.language_manager.code') }}</th>
                           @if ($lang != 'en')
                           <th>English</th>
                           @endif
