...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <form action="{{ gc_route_admin('admin_plugin.process_import') }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="import-product" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div>
                                    ...
                                    <span class="form-text">
                                        <i class="fa fa-info-circle"></i> {!! gc_language_render('admin.plugin.import_note') !!}
                                    </span>
                                    @endif
                                </div>
                            </div>
