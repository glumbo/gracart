                ...
                @foreach ($languages as $code => $language)
                    <div class="card">
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__title"
                                class="col-sm-2 col-form-label">{{ gc_language_render('admin.page.title') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__keyword"
                                class="col-sm-2 col-form-label">{{ gc_language_render('admin.page.keyword') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__description"
                                class="col-sm-2 col-form-label">{{ gc_language_render('admin.page.description') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__content"
                                class="col-sm-2 col-form-label">{{ gc_language_render('admin.page.content') }}</label>
                            <div class="col-sm-8">
                    ...
                    @endforeach
                        ...
                        <div class="form-group row  {{ $errors->has('image') ? ' text-red' : '' }}">
                            <label for="image" class="col-sm-2 col-form-label">{{ gc_language_render('admin.page.image') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="text" id="image" name="image"
                                        ...
                                        <div class="input-group-append">
                                            <a data-input="image" data-preview="preview_image" data-type="page"
                                                ...
                                                <i class="fa fa-image"></i> {{gc_language_render('admin.page.choose_image')}}
                                            </a>
                                        </div>
                                </div>
                                @if ($errors->has('image'))
                                ...
                                <div id="preview_image" class="img_holder">
                                    ...
                                    <img src="{{ gc_file(old('image',($page['image']??''))) }}">
                                    @endif
                        ...
                        <div class="form-group row  {{ $errors->has('alias') ? ' text-red' : '' }}">
                            <label for="alias"
                                class="col-sm-2 col-form-label">{!! gc_language_render('admin.page.alias') !!}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
...
@if (gc_check_multi_shop_installed())
                        ...
                        if (function_exists('gc_get_list_store_of_page_detail')) {
                                $oldData = gc_get_list_store_of_page_detail($page['id'] ?? '');
                            } else {
                                $oldData = null;
                            }
...
@endif
                        ...
                        <div class="form-group row ">
                            <label for="status" class="col-sm-2 col-form-label">{{ gc_language_render('admin.page.status') }}</label>
                            <div class="col-sm-8">
