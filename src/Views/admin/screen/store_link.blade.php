                ...
                <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main"  enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                            <div class="form-group row {{ $errors->has('name') ? ' text-red' : '' }}">
                                <label for="name" class="col-sm-2 col-form-label">{{ gc_language_render('admin.link.name') }}</label>
                                <div class="col-sm-8">
...
@if ($layout !='collection')
                            <div class="form-group row {{ $errors->has('url') ? ' text-red' : '' }}">
                                <label for="url" class="col-sm-2 col-form-label">{{ gc_language_render('admin.link.url') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                        ...
                                        @else
                                            <span class="form-text">
                                                <i class="fa fa-info-circle"></i> {{ gc_language_render('admin.link.helper_url') }}
                                            </span>
                                        @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group row {{ $errors->has('target') ? ' text-red' : '' }}">
                                <label for="target" class="col-sm-2 col-form-label">{{ gc_language_render('admin.link.select_target') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row {{ $errors->has('collection_id') ? ' text-red' : '' }}">
                                <label for="group" class="col-sm-2 col-form-label">{{ gc_language_render('admin.link.select_collection') }}</label>
                                <div class="col-sm-8">
...
@endif
                            ...
                            <div class="form-group row {{ $errors->has('group') ? ' text-red' : '' }}">
                                <label for="group" class="col-sm-2 col-form-label">{{ gc_language_render('admin.link.select_group') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <a href="{{ gc_route_admin('admin_store_link_group.index') }}" class="btn  btn-flat" title="New">
                            ...
                            <div class="form-group row {{ $errors->has('sort') ? ' text-red' : '' }}">
                                <label for="sort" class="col-sm-2 col-form-label">{{ gc_language_render('admin.link.sort') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
...
@if (gc_check_multi_shop_installed())
                            ...
                            @php
                            $listStore = [];
                            if (function_exists('gc_get_list_store_of_link_detail')) {
                                $oldData = gc_get_list_store_of_link_detail($link['id'] ?? '');
                            } else {
                                $oldData = null;
                            }
...
@endif
                            ...
                            <div class="form-group row ">
                                <label for="status" class="col-sm-2 col-form-label">{{ gc_language_render('admin.link.status') }}</label>
                                <div class="col-sm-8">
