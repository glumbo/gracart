    ...
    <div class="card">
      ...
      <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main">
        <div class="card-body">
          ...
          @includeIf($templatePathAdmin.'forms.input', ['col' => 10, 'name' => 'name', 'data' => $supplier ?? null, 'label' => gc_language_render('admin.supplier.name')])
          @includeIf($templatePathAdmin.'forms.input', ['col' => 10, 'name' => 'alias', 'data' => $supplier ?? null, 'label' => gc_language_render('admin.supplier.alias'), 'info' => gc_language_render('admin.supplier.alias_validate')])
          @includeIf($templatePathAdmin.'forms.input', ['col' => 10, 'name' => 'phone', 'data' => $supplier ?? null, 'label' => gc_language_render('admin.supplier.phone'), 'prepend' => 'phone'])
          @includeIf($templatePathAdmin.'forms.input', ['col' => 10, 'name' => 'url', 'data' => $supplier ?? null, 'label' => gc_language_render('admin.supplier.url'), 'prepend' => 'anchor'])
          @includeIf($templatePathAdmin.'forms.input', ['col' => 10, 'name' => 'email', 'data' => $supplier ?? null, 'label' => gc_language_render('admin.supplier.email'), 'prepend' => 'envelope'])
          @includeIf($templatePathAdmin.'forms.input', ['col' => 10, 'name' => 'address', 'data' => $supplier ?? null, 'label' => gc_language_render('admin.supplier.address')])
          @includeIf($templatePathAdmin.'forms.file', ['col' => 10, 'name' => 'image', 'data' => $supplier ?? null, 'type' => 'supplier', 'label' => gc_language_render('admin.supplier.image'),  'text' => gc_language_render('product.admin.choose_image'), 'sub_images' => [], 'multiple' => 0 ])
          @includeIf($templatePathAdmin.'forms.input', ['col' => 10, 'name' => 'sort', 'type' => 'number',  'data' => $supplier ?? null, 'label' => gc_language_render('admin.supplier.sort'), 'step' => '1', 'prepend' => 'sort-amount-desc'])
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.error == 1){
                      ...
                      window.location.replace('{{ gc_route_admin('admin_supplier.index') }}');
                    }
