  ...
  <div class="card-body table-responsivep-0">
   <table class="table table-hover box-body text-wrap table-bordered">
     ...
     <tbody>
       ...
       <tr>
        <td>{{ gc_language_render($policy['detail']) }}</td>
        <td><a href="#" class="editable-required editable editable-click" data-name="{{ $policy['key'] }}" data-type="text" data-pk="" data-source="" data-url="{{ $urlUpdateConfigGlobal }}" data-title="{{ gc_language_render($policy['detail']) }}" data-value="{{ $policy['value'] }}" data-original-title="" title=""></a></td>
      </tr>
       @else
       <tr>
        <td>{{ gc_language_render($policy['detail']) }}</td>
