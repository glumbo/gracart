      ...
      <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main">
        <div class="card-body">
          ...
          <div class="form-group row {{ $errors->has('name') ? ' text-red' : '' }}">
            <label for="name" class="col-sm-2 col-form-label">{{ gc_language_render('admin.brand.name') }}</label>
            <div class="col-sm-10 ">
          ...
          <div class="form-group row {{ $errors->has('alias') ? ' text-red' : '' }}">
            <label for="alias" class="col-sm-2 col-form-label">{!! gc_language_render('admin.brand.alias') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
          ...
          <div class="form-group row {{ $errors->has('url') ? ' text-red' : '' }}">
            <label for="url" class="col-sm-2 col-form-label">{!! gc_language_render('admin.brand.url') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
          ...
          <div class="form-group row {{ $errors->has('image') ? ' text-red' : '' }}">
            <label for="image" class="col-sm-2 col-form-label">{!! gc_language_render('admin.brand.image') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
              ...
              <div id="preview_image" class="img_holder"><img
                src="{{ gc_file(old('image',$brand['image']??'images/no-image.jpg')) }}">
              </div>
              @if ($errors->has('image'))
              <span class="text-sm">
          ...
          <div class="form-group row {{ $errors->has('sort') ? ' text-red' : '' }}">
            <label for="sort" class="col-sm-2 col-form-label">{!! gc_language_render('admin.brand.sort') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
...
@if (gc_check_multi_shop_installed())
          ...
          @php
          $listStore = [];
          if (function_exists('gc_get_list_store_of_brand_detail')) {
                  $oldData = gc_get_list_store_of_brand_detail($brand['id'] ?? '');
              } else {
                  $oldData = null;
              }
...
@endif
          ...
          <div class="form-group row {{ $errors->has('status') ? ' text-red' : '' }}">
            <label for="status" class="col-sm-2 col-form-label">{!! gc_language_render('admin.brand.status') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
