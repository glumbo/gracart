                ...
                <div class="card-body">
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__title"
                                class="col-sm-2 col-form-label">{{ gc_language_render('admin.news.title') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__keyword"
                                class="col-sm-2 col-form-label">{{ gc_language_render('admin.news.keyword') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__description"
                                class="col-sm-2 col-form-label">{{ gc_language_render('admin.news.description') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__content"
                                class="col-sm-2 col-form-label">{{ gc_language_render('admin.news.content') }}</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group  row {{ $errors->has('alias') ? ' text-red' : '' }}">
                            <label for="alias"
                                class="col-sm-2 col-form-label">{!! gc_language_render('admin.news.alias') !!}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div class="form-group  row {{ $errors->has('image') ? ' text-red' : '' }}">
                            <label for="image" class="col-sm-2 col-form-label">{{ gc_language_render('admin.news.image') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                ...
                                <div id="preview_image" class="img_holder">
                                    ...
                                    <img src="{{ gc_file(old('image',$news['image']??'')) }}">
                                    @endif
                        ...
                        <div class="form-group  row {{ $errors->has('sort') ? ' text-red' : '' }}">
                            <label for="sort" class="col-sm-2 col-form-label">{{ gc_language_render('admin.news.sort') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
...
@if (gc_check_multi_shop_installed())
                        ...
                        @php
                        $listStore = [];
                        if (function_exists('gc_get_list_store_of_news_detail')) {
                                $oldData = gc_get_list_store_of_news_detail($news['id'] ?? '');
                            } else {
                                $oldData = null;
                            }
...
@endif
                        ...
                        <div class="form-group  row">
                            <label for="status" class="col-sm-2 col-form-label">{{ gc_language_render('admin.news.status') }}</label>
                            <div class="col-sm-8">
