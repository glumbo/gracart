...
(function( $ ){
      ...
      $.fn.filemanager = function(type, options) {
        ...
        this.on('click', function(e) {
          ...
          var route_prefix = (options && options.prefix) ? options.prefix : '{{ gc_route_admin('admin.home').'/'.config('lfm.url_prefix') }}';
          var target_input = $('#' + $(this).data('input'));
          var target_preview = $('#' + $(this).data('preview'));
          window.open(route_prefix + '?type=' + type, '{{ gc_language_render('admin.file_manager') }}', 'width=900,height=600');
