        ...
        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
            ...
            @if (count($menus))
                @foreach ($menus[0] as $item)
                    @includeIf($templatePathAdmin.'component.tools.menu-item')
                @endforeach
...
{{--                                                          fill="currentColor"/>--}}
{{--													<path d="M22 4C22 2.9 21.1 2 20 2C18.9 2 18 2.9 18 4C18 4.7 18.4 5.29995 18.9 5.69995C18.1 12.6 12.6 18.2 5.70001 18.9C5.30001 18.4 4.7 18 4 18C2.9 18 2 18.9 2 20C2 21.1 2.9 22 4 22C4.8 22 5.39999 21.6 5.79999 20.9C13.8 20.1 20.1 13.7 20.9 5.80005C21.6 5.40005 22 4.8 22 4Z"--}}
{{--                                                          fill="currentColor"/>--}}
{{--												</svg>--}}
{{--											</span>--}}
{{--                                            <!--end::Svg Icon-->--}}
...
{{--                                    <div class="menu-item">--}}
{{--                                        <a class="menu-link"--}}
{{--                                           href="../../demo1/dist/utilities/modals/wizards/two-factor-authentication.html">--}}
{{--																<span class="menu-bullet">--}}
{{--																	<span class="bullet bullet-dot"></span>--}}
{{--																</span>--}}
{{--                                            <span class="menu-title">Two Factor Auth</span>--}}
...
{{--                            <div class="menu-item">--}}
{{--                                <a class="menu-link"--}}
{{--                                   href="../../demo1/dist/utilities/wizards/two-factor-authentication.html">--}}
{{--														<span class="menu-bullet">--}}
{{--															<span class="bullet bullet-dot"></span>--}}
{{--														</span>--}}
{{--                                    <span class="menu-title">Two Factor Auth</span>--}}
