                    ...
                    <div class="card-body">
                        <div class="fields-group">
                            ...
                            <div class="form-group row  {{ $errors->has('name') ? ' text-red' : '' }}">
                                <label for="name" class="col-sm-2  control-label">{{ gc_language_render('admin.permission.name') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row  {{ $errors->has('slug') ? ' text-red' : '' }}">
                                <label for="slug" class="col-sm-2  control-label">{{ gc_language_render('admin.permission.slug') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
...
{{-- select http_method --}}
    ...
    @endphp
                                <label for="http_uri" class="col-sm-2  control-label">{{ gc_language_render('admin.permission.select_http_uri') }}</label>
                                <div class="col-sm-8">
                                    <select class="form-control input-sm http_uri select2"  multiple="multiple" data-placeholder="{{ gc_language_render('admin.permission.method_placeholder') }}" style="width: 100%;" name="http_uri[]" >
                                        <option value=""></option>
