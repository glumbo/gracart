                ...
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right mr-5">
                            <a href="{{ gc_route_admin('admin_role.index') }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{ gc_language_render('admin.back_list') }}</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                    ...
                    <div class="card-body">
                        <div class="fields-group">
                            ...
                            <div class="form-group  row {{ $errors->has('name') ? ' text-red' : '' }}">
                                <label for="name" class="col-sm-2  control-label">{{ gc_language_render('admin.role.name') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group  row {{ $errors->has('slug') ? ' text-red' : '' }}">
                                <label for="slug" class="col-sm-2  control-label">{{ gc_language_render('admin.role.slug') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
...
@endphp
                            <div class="form-group row {{ $errors->has('permission') ? ' text-red' : '' }}">
                                <label for="permission" class="col-sm-2  control-label">{{ gc_language_render('admin.role.select_permission') }}</label>
                                <div class="col-sm-8">
                                    <select class="form-control input-sm permission select2"  multiple="multiple" data-placeholder="{{ gc_language_render('admin.role.select_permission') }}" style="width: 100%;" name="permission[]" >
                                        <option value=""></option>
...
@endphp
                        <div class="form-group row {{ $errors->has('administrators') ? ' text-red' : '' }}">
                            <label for="administrators" class="col-sm-2  control-label">{{ gc_language_render('admin.role.select_user') }}</label>
                            <div class="col-sm-8">
                                <select class="form-control input-sm administrators select2"  multiple="multiple" data-placeholder="{{ gc_language_render('admin.role.select_user') }}" style="width: 100%;" name="administrators[]" >
                                    <option value=""></option>
