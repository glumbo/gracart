...
<div class="container">
    ...
    <div class="col-md-5 col-sm-8">
        ...
        <button type="button" class="btn btn-default dropdown-toggle usa" data-toggle="dropdown">
            ...
            <img src="https://grakan.org/data/language/flag_vn.png" style="height: 25px;">
            @else
            <img src="https://grakan.org/data/language/flag_uk.png" style="height: 25px;">
            @endif
        ...
        <span class="caret"></span>
          ...
          <ul class="dropdown-menu" >
              <li><a href="install.php"><img src="https://grakan.org/data/language/flag_uk.png" style="height: 25px;"></a></li>
              <li><a href="install.php?lang=vi"><img src="https://grakan.org/data/language/flag_vn.png" style="height: 25px;"></a></li>
          </ul>
        </div>
        <div style="clear: both;display: block;">
            ...
            <p><b>{{ trans('install.info.version') }}</b>: {{ config('grakan.version') }}</p>
            ...
            <div class="panel-body" >
                    <form  class="form-horizontal" id="formInstall">
                        ...
                        <div id="div_database_name" class="form-group info-install required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md  textInput form-control" id="database_name"  name="database_name" placeholder="{{ trans('install.database_name') }}" style="margin-bottom: 10px" type="text" value="grakan" />
                            </div>
                        </div>
                        ...
                        <div id="div_database_prefix" class="form-group info-install">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md  textInput form-control" id="database_prefix"  name="database_prefix" placeholder="{{ trans('install.database_prefix_help') }}" style="margin-bottom: 10px" type="text"  value="gc_" />
                            </div>
                        </div>
                        <hr>
                        ...
                        <div id="div_admin_url" class="form-group info-install required">
                            ...
                            <div class="controls col-md-8">
                                <input class="input-md  textInput form-control" id="admin_url"  name="admin_url" placeholder="{{ trans('install.admin_url') }}" style="margin-bottom: 10px" type="text" value="gc_admin" />
                            </div>
                        </div>
