<?php
namespace Glumbo\Gracart\DB\migrations;
...
class PrepareTablesShop extends Migration
{
    ...
    public function up()
    {
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_email_template',
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_shipping_standard',
            function (Blueprint $table) {
                $table->increments('id');
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_category_description',
            function (Blueprint $table) {
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_order_detail',
            function (Blueprint $table) {
                $table->uuid('id')->primary();
                $table->uuid('order_id');
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_order_history',
            function (Blueprint $table) {
                $table->uuid('id')->primary();
                $table->uuid('order_id');
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_order_status',
            function (Blueprint $table) {
                $table->increments('id');
                $table->string('name', 255);
                $table->timestamps();
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_payment_status',
            function (Blueprint $table) {
                $table->increments('id');
                $table->string('name', 255);
                $table->timestamps();
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_product_description',
            function (Blueprint $table) {
                $table->uuid('product_id');
                $table->string('lang', 10)->index();
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_product_image',
            function (Blueprint $table) {
                $table->uuid('id')->primary();
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_product_build',
            function (Blueprint $table) {
                $table->uuid('build_id');
                $table->uuid('product_id');
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_product_group',
            function (Blueprint $table) {
                $table->uuid('group_id');
                $table->uuid('product_id');
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_product_category',
            function (Blueprint $table) {
                $table->uuid('product_id');
                $table->uuid('category_id');
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_attribute_group',
            function (Blueprint $table) {
                $table->increments('id');
                $table->string('name', 255);
                $table->tinyInteger('status')->default(0);
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_product_attribute',
            function (Blueprint $table) {
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_product_property',
            function (Blueprint $table) {
                $table->increments('id');
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_shipping_status',
            function (Blueprint $table) {
                $table->increments('id');
                $table->string('name', 255);
                $table->timestamps();
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_shoppingcart',
            function (Blueprint $table) {
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_customer_address',
            function (Blueprint $table) {
                $table->uuid('id')->primary();
                $table->uuid('customer_id')->index();
                $table->string('first_name', 100);
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_product_promotion',
            function (Blueprint $table) {
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_product_download',
            function (Blueprint $table) {
                $table->uuid('id')->primary();
                $table->uuid('product_id');
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_custom_field',
            function (Blueprint $table) {
                $table->uuid('id')->primary();
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_custom_field_detail',
            function (Blueprint $table) {
                $table->uuid('id')->primary();
        ...
        //Multi store
        $schema->create(
            GC_DB_PREFIX.'shop_product_store',
            function (Blueprint $table) {
                $table->uuid('product_id');
                $table->uuid('store_id');
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_category_store',
            function (Blueprint $table) {
                $table->uuid('category_id');
                $table->uuid('store_id');
        ...
        $schema->create(
            GC_DB_PREFIX.'shop_password_resets',
            function (Blueprint $table) {
                $table->string('email', 150);
    ...
    {
        $schema = Schema::connection(GC_CONNECTION);
        $schema->dropIfExists(GC_DB_PREFIX.'shop_email_template');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_shipping_standard');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_api');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_api_process');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_brand');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_category');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_category_description');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_currency');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_order');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_order_detail');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_order_history');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_order_status');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_order_total');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_payment_status');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_product');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_product_description');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_product_image');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_product_build');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_product_attribute');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_product_property');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_attribute_group');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_product_group');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_product_category');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_shipping_status');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_shoppingcart');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_product_promotion');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_customer');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_supplier');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_customer_address');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_password_resets');

        $schema->dropIfExists(GC_DB_PREFIX.'shop_sessions');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_tax');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_weight');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_length');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_product_download');
        //Api connection
        $schema->dropIfExists(GC_DB_PREFIX.'api_connection');
        //Job
        $schema->dropIfExists('jobs');
        $schema->dropIfExists('failed_jobs');
        //Custom field
        $schema->dropIfExists(GC_DB_PREFIX.'shop_custom_field');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_custom_field_detail');
        //Languages
        $schema->dropIfExists(GC_DB_PREFIX.'languages');
        //Multi store
        $schema->dropIfExists(GC_DB_PREFIX.'shop_product_store');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_category_store');
        $schema->dropIfExists(GC_DB_PREFIX.'shop_brand_store');
