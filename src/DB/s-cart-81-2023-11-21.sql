...
-- Dumping database structure for grakan
CREATE DATABASE IF NOT EXISTS `grakan` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `grakan`;

-- Dumping structure for table grakan.failed_jobs
...
-- Dumping data for table grakan.failed_jobs: ~0 rows (approximately)
DELETE FROM `failed_jobs`;
/*!40000 ALTER TABLE `failed_jobs` DISABLE KEYS */;
/*!40000 ALTER TABLE `failed_jobs` ENABLE KEYS */;

-- Dumping structure for table grakan.jobs
...
-- Dumping data for table grakan.jobs: ~0 rows (approximately)
DELETE FROM `jobs`;
/*!40000 ALTER TABLE `jobs` DISABLE KEYS */;
/*!40000 ALTER TABLE `jobs` ENABLE KEYS */;

-- Dumping structure for table grakan.migrations
...
-- Dumping data for table grakan.migrations: ~3 rows (approximately)
...
-- Dumping structure for table grakan.personal_access_tokens
...
-- Dumping data for table grakan.personal_access_tokens: ~0 rows (approximately)
DELETE FROM `personal_access_tokens`;
/*!40000 ALTER TABLE `personal_access_tokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `personal_access_tokens` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_config
CREATE TABLE IF NOT EXISTS `gc_admin_config` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_admin_config_key_store_id_unique` (`key`,`store_id`),
  KEY `gc_admin_config_code_index` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=143 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_config: ~142 rows (approximately)
DELETE FROM `gc_admin_config`;
/*!40000 ALTER TABLE `gc_admin_config` DISABLE KEYS */;
INSERT INTO `gc_admin_config` (`id`, `group`, `code`, `key`, `value`, `security`, `store_id`, `sort`, `detail`, `created_at`, `updated_at`) VALUES
	...
	(134, '', 'admin_custom_config', 'facebook_url', 'https://www.facebook.com/GCart.Ecommerce/', 0, '1', 0, 'admin.admin_custom_config.facebook_url', NULL, NULL),
...
/*!40000 ALTER TABLE `gc_admin_config` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_log
CREATE TABLE IF NOT EXISTS `gc_admin_log` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_admin_log_user_id_index` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_log: ~0 rows (approximately)
DELETE FROM `gc_admin_log`;
/*!40000 ALTER TABLE `gc_admin_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_admin_log` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_menu
CREATE TABLE IF NOT EXISTS `gc_admin_menu` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_admin_menu_key_unique` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_menu: ~68 rows (approximately)
DELETE FROM `gc_admin_menu`;
/*!40000 ALTER TABLE `gc_admin_menu` DISABLE KEYS */;
INSERT INTO `gc_admin_menu` (`id`, `parent_id`, `sort`, `title`, `icon`, `uri`, `type`, `hidden`, `key`, `created_at`, `updated_at`) VALUES
	...
	(39, 35, 0, 'grakan::admin.menu_titles.plugin_payment', 'far fa-money-bill-alt', 'admin::plugin/payment', 0, 0, NULL, NULL, NULL),
	(40, 35, 1, 'grakan::admin.menu_titles.plugin_shipping', 'fas fa-ambulance', 'admin::plugin/shipping', 0, 0, NULL, NULL, NULL),
	(41, 35, 2, 'grakan::admin.menu_titles.plugin_total', 'fas fa-atom', 'admin::plugin/total', 0, 0, NULL, NULL, NULL),
	(42, 35, 100, 'grakan::admin.menu_titles.plugin_other', 'far fa-circle', 'admin::plugin/other', 0, 0, NULL, NULL, NULL),
	(43, 35, 4, 'grakan::admin.menu_titles.plugin_cms', 'fab fa-modx', 'admin::plugin/cms', 0, 0, NULL, NULL, NULL),
	...
	(53, 35, 3, 'grakan::admin.menu_titles.plugin_fee', 'fas fa-box', 'admin::plugin/fee', 0, 0, NULL, NULL, NULL),
...
/*!40000 ALTER TABLE `gc_admin_menu` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_notice
CREATE TABLE IF NOT EXISTS `gc_admin_notice` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_admin_notice_type_index` (`type`),
  KEY `gc_admin_notice_type_id_index` (`type_id`),
  KEY `gc_admin_notice_status_index` (`status`),
  KEY `gc_admin_notice_admin_id_index` (`admin_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_notice: ~0 rows (approximately)
DELETE FROM `gc_admin_notice`;
/*!40000 ALTER TABLE `gc_admin_notice` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_admin_notice` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_password_resets
CREATE TABLE IF NOT EXISTS `gc_admin_password_resets` (
  `email` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `token` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL,
  KEY `gc_admin_password_resets_email_index` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_password_resets: ~0 rows (approximately)
DELETE FROM `gc_admin_password_resets`;
/*!40000 ALTER TABLE `gc_admin_password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_admin_password_resets` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_permission
CREATE TABLE IF NOT EXISTS `gc_admin_permission` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_admin_permission_name_unique` (`name`),
  UNIQUE KEY `gc_admin_permission_slug_unique` (`slug`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_permission: ~13 rows (approximately)
DELETE FROM `gc_admin_permission`;
/*!40000 ALTER TABLE `gc_admin_permission` DISABLE KEYS */;
INSERT INTO `gc_admin_permission` (`id`, `name`, `slug`, `http_uri`, `created_at`, `updated_at`) VALUES
	(1, 'Auth manager', 'auth.full', 'ANY::gc_admin/auth/*', NULL, NULL),
	(2, 'Dashboard', 'dashboard', 'GET::gc_admin', NULL, NULL),
	(3, 'Base setting', 'base.setting', 'ANY::gc_admin/order_status/*,ANY::gc_admin/shipping_status/*,ANY::gc_admin/payment_status/*,ANY::gc_admin/supplier/*,ANY::gc_admin/brand/*,ANY::gc_admin/custom_field/*,ANY::gc_admin/weight_unit/*,ANY::gc_admin/length_unit/*,ANY::gc_admin/attribute_group/*,ANY::gc_admin/tax/*', NULL, NULL),
	(4, 'Store manager', 'store.full', 'ANY::gc_admin/store_info/*,ANY::gc_admin/store_maintain/*,ANY::gc_admin/store_config/*,ANY::gc_admin/store_css/*,ANY::gc_admin/store_block/*,ANY::gc_admin/store_link/*', NULL, NULL),
	(5, 'Product manager', 'product.full', 'ANY::gc_admin/product/*,ANY::gc_admin/product_property/*,ANY::gc_admin/product_tag/*', NULL, NULL),
	(6, 'Category manager', 'category.full', 'ANY::gc_admin/category/*', NULL, NULL),
	(7, 'Order manager', 'order.full', 'ANY::gc_admin/order/*', NULL, NULL),
	(8, 'Upload management', 'upload.full', 'ANY::gc_admin/uploads/*', NULL, NULL),
	(9, 'Extension manager', 'extension.full', 'ANY::gc_admin/template/*,ANY::gc_admin/plugin/*', NULL, NULL),
	(10, 'Marketing manager', 'marketing.full', 'ANY::gc_admin/shop_discount/*,ANY::gc_admin/email_template/*,ANY::gc_admin/customer/*,ANY::gc_admin/subscribe/*,ANY::gc_admin/seo/*', NULL, NULL),
	(11, 'Report manager', 'report.full', 'ANY::gc_admin/report/*', NULL, NULL),
	(12, 'CMS full', 'cms.full', 'ANY::gc_admin/page/*,ANY::gc_admin/banner/*,ANY::gc_admin/banner_type/*,ANY::gc_admin/cms_category/*,ANY::gc_admin/cms_content/*,ANY::gc_admin/news/*', NULL, NULL),
	(13, 'Update config', 'change.config', 'POST::gc_admin/store_config/update', NULL, NULL);
/*!40000 ALTER TABLE `gc_admin_permission` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_role
CREATE TABLE IF NOT EXISTS `gc_admin_role` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_admin_role_slug_unique` (`slug`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_role: ~7 rows (approximately)
DELETE FROM `gc_admin_role`;
/*!40000 ALTER TABLE `gc_admin_role` DISABLE KEYS */;
INSERT INTO `gc_admin_role` (`id`, `name`, `slug`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `gc_admin_role` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_role_permission
CREATE TABLE IF NOT EXISTS `gc_admin_role_permission` (
  `role_id` int NOT NULL,
  `permission_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`role_id`,`permission_id`),
  KEY `gc_admin_role_permission_role_id_permission_id_index` (`role_id`,`permission_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_role_permission: ~30 rows (approximately)
DELETE FROM `gc_admin_role_permission`;
/*!40000 ALTER TABLE `gc_admin_role_permission` DISABLE KEYS */;
INSERT INTO `gc_admin_role_permission` (`role_id`, `permission_id`, `created_at`, `updated_at`) VALUES
	(3, 1, NULL, NULL),
	(3, 2, NULL, NULL),
	(3, 3, NULL, NULL),
	(3, 4, NULL, NULL),
	...
	(7, 12, NULL, NULL),
	(7, 13, NULL, NULL);
/*!40000 ALTER TABLE `gc_admin_role_permission` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_role_user
CREATE TABLE IF NOT EXISTS `gc_admin_role_user` (
  `role_id` int NOT NULL,
  `user_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`role_id`,`user_id`),
  KEY `gc_admin_role_user_role_id_user_id_index` (`role_id`,`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_role_user: ~1 rows (approximately)
DELETE FROM `gc_admin_role_user`;
/*!40000 ALTER TABLE `gc_admin_role_user` DISABLE KEYS */;
INSERT INTO `gc_admin_role_user` (`role_id`, `user_id`, `created_at`, `updated_at`) VALUES
	(1, '1', NULL, NULL);
/*!40000 ALTER TABLE `gc_admin_role_user` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_store
CREATE TABLE IF NOT EXISTS `gc_admin_store` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `logo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `icon` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `og_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'images/org.jpg',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_admin_store_code_unique` (`code`),
  KEY `gc_admin_store_domain_index` (`domain`),
  KEY `gc_admin_store_partner_index` (`partner`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_store: ~1 rows (approximately)
DELETE FROM `gc_admin_store`;
/*!40000 ALTER TABLE `gc_admin_store` DISABLE KEYS */;
INSERT INTO `gc_admin_store` (`id`, `logo`, `icon`, `og_image`, `phone`, `long_phone`, `email`, `time_active`, `address`, `office`, `warehouse`, `template`, `domain`, `partner`, `code`, `language`, `timezone`, `currency`, `status`, `active`, `created_at`, `updated_at`) VALUES
	('1', 'data/logo/scart-mid.png', NULL, 'images/org.jpg', '0123456789', 'Support: 0987654321', 'admin@example.com', '', '123st - abc - xyz', NULL, NULL, 'grakan-light', 'grakan.local', '0', 'grakan', 'vi', '', 'USD', 1, 1, NULL, NULL);
/*!40000 ALTER TABLE `gc_admin_store` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_store_description
CREATE TABLE IF NOT EXISTS `gc_admin_store_description` (
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lang` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `keyword` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `maintain_content` mediumtext COLLATE utf8mb4_unicode_ci,
  `maintain_note` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`store_id`,`lang`),
  KEY `gc_admin_store_description_lang_index` (`lang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_store_description: ~2 rows (approximately)
DELETE FROM `gc_admin_store_description`;
/*!40000 ALTER TABLE `gc_admin_store_description` DISABLE KEYS */;
INSERT INTO `gc_admin_store_description` (`store_id`, `lang`, `title`, `description`, `keyword`, `maintain_content`, `maintain_note`) VALUES
...
/*!40000 ALTER TABLE `gc_admin_store_description` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_template
CREATE TABLE IF NOT EXISTS `gc_admin_template` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_admin_template_key_unique` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_template: ~1 rows (approximately)
DELETE FROM `gc_admin_template`;
/*!40000 ALTER TABLE `gc_admin_template` DISABLE KEYS */;
INSERT INTO `gc_admin_template` (`id`, `key`, `name`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'grakan-light', 'S-Cart Light', 1, NULL, NULL);
/*!40000 ALTER TABLE `gc_admin_template` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_user
CREATE TABLE IF NOT EXISTS `gc_admin_user` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_admin_user_username_unique` (`username`),
  UNIQUE KEY `gc_admin_user_email_unique` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_user: ~1 rows (approximately)
DELETE FROM `gc_admin_user`;
/*!40000 ALTER TABLE `gc_admin_user` DISABLE KEYS */;
INSERT INTO `gc_admin_user` (`id`, `username`, `password`, `name`, `email`, `avatar`, `remember_token`, `theme`, `created_at`, `updated_at`) VALUES
	('1', 'admin', '$2y$10$usCxthCicMyuOPKJ4OJetOMWbfxmgw6oYMkndR8/b7qgTh03DaWOe', 'Administrator', 'admin@example.com', '/admin/avatar/user.jpg', NULL, NULL, NULL, NULL);
/*!40000 ALTER TABLE `gc_admin_user` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_admin_user_permission
CREATE TABLE IF NOT EXISTS `gc_admin_user_permission` (
  `user_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `permission_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`user_id`,`permission_id`),
  KEY `gc_admin_user_permission_user_id_permission_id_index` (`user_id`,`permission_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_admin_user_permission: ~0 rows (approximately)
DELETE FROM `gc_admin_user_permission`;
/*!40000 ALTER TABLE `gc_admin_user_permission` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_admin_user_permission` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_api_connection
CREATE TABLE IF NOT EXISTS `gc_api_connection` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_api_connection_apiconnection_unique` (`apiconnection`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_api_connection: ~1 rows (approximately)
DELETE FROM `gc_api_connection`;
/*!40000 ALTER TABLE `gc_api_connection` DISABLE KEYS */;
INSERT INTO `gc_api_connection` (`id`, `description`, `apiconnection`, `apikey`, `expire`, `last_active`, `created_at`, `updated_at`, `status`) VALUES
	(1, 'Demo api connection', 'appmobile', '9aaaab35-7ffd-4d47-a0c3-f2320b08b3e2', NULL, NULL, NULL, NULL, 0);
/*!40000 ALTER TABLE `gc_api_connection` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_languages
CREATE TABLE IF NOT EXISTS `gc_languages` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_languages_code_location_unique` (`code`,`location`),
  KEY `gc_languages_code_index` (`code`),
  KEY `gc_languages_position_index` (`position`),
  KEY `gc_languages_location_index` (`location`)
) ENGINE=InnoDB AUTO_INCREMENT=2762 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_languages: ~2,761 rows (approximately)
DELETE FROM `gc_languages`;
/*!40000 ALTER TABLE `gc_languages` DISABLE KEYS */;
INSERT INTO `gc_languages` (`id`, `code`, `text`, `position`, `location`, `created_at`, `updated_at`) VALUES
	...
	(1522, 'admin.backup.guide', '<span class="text-danger">Chú ý: Bạn cần phải cài đặt đường dẫn hệ thống chính xác. Xem hướng dẫn <a target=_new href="https://grakan.org/guide/backup.html?lang=vi">TẠI ĐÂY</a></span>', 'admin.backup', 'vi', NULL, NULL),
	...
	(1536, 'admin.backup.guide', '<span class="text-danger">NOTE: To use MySQL server on the command line, you must have the correct system path. This is usually done automatically. Read document in <a target=_new href="https://grakan.org/guide/backup.html">HERE</a></span>', 'admin.backup', 'en', NULL, NULL),
	...
	(1941, 'email.email_action.help_note', '<span class="text-red">(*)</span>: Email sẽ không được gửi trực tiếp, mà thông qua hàng đợi. Bạn cần phải cài đặt "artisan schedule:run" trước,  chi tiết <a href="https://grakan.org/docs/master/email.html">TẠI ĐÂY</a>', 'email.admin', 'vi', NULL, NULL),
	(1942, 'email.email_action.help_note', '<span class="text-red">(*)</span>: Emails will not be sent directly, but through a queue. You need to set up "artisan schedule: run" first, details <a href="https://grakan.org/docs/master/email.html">HERE</a>', 'email.admin', 'en', NULL, NULL),
	...
	(2346, 'admin.template.template_more', '<a href="https://grakan.org/en/template.html" target=_new><i class="fa fa-download" aria-hidden="true"></i> Download more HERE</a>', 'admin.template', 'en', NULL, NULL),
	...
	(2391, 'admin.template.template_more', '<a href="https://grakan.org/vi/template.html" target=_new><i class="fa fa-download" aria-hidden="true"></i> Download đầy đủ Ở ĐÂY</a>', 'admin.template', 'vi', NULL, NULL),
	...
	(2475, 'admin.plugin.plugin_more', '<a href="https://grakan.org/vi/plugin.html" target=_new><i class="fa fa-download" aria-hidden="true"></i> Download đầy đủ Ở ĐÂY</a>', 'admin.plugin', 'vi', NULL, NULL),
	...
	(2543, 'admin.plugin.plugin_more', '<a href="https://grakan.org/en/plugin.html" target=_new><i class="fa fa-download" aria-hidden="true"></i> Download more HERE</a>', 'admin.plugin', 'en', NULL, NULL),
	...
	(2554, 'admin.plugin.not_compatible', 'Lỗi không tương thích. Plugin/template này chỉ hỗ trợ các phiên bản :version. Phiên bản hiện tại là :gc_version', 'admin.plugin', 'vi', NULL, NULL),
	(2555, 'admin.plugin.not_compatible', 'Incompatibility error. This plugin/template only supports :version versions. The current version is :gc_version', 'admin.plugin', 'en', NULL, NULL),
...
/*!40000 ALTER TABLE `gc_languages` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_attribute_group
CREATE TABLE IF NOT EXISTS `gc_shop_attribute_group` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` tinyint NOT NULL DEFAULT '0',
  `sort` int NOT NULL DEFAULT '0',
...
-- Dumping data for table grakan.gc_shop_attribute_group: ~2 rows (approximately)
DELETE FROM `gc_shop_attribute_group`;
/*!40000 ALTER TABLE `gc_shop_attribute_group` DISABLE KEYS */;
INSERT INTO `gc_shop_attribute_group` (`id`, `name`, `status`, `sort`, `type`, `created_at`, `updated_at`) VALUES
	(1, 'Color', 1, 1, 'radio', NULL, NULL),
	(2, 'Size', 1, 2, 'select', NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_attribute_group` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_banner
CREATE TABLE IF NOT EXISTS `gc_shop_banner` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_banner_type_index` (`type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_banner: ~8 rows (approximately)
DELETE FROM `gc_shop_banner`;
/*!40000 ALTER TABLE `gc_shop_banner` DISABLE KEYS */;
INSERT INTO `gc_shop_banner` (`id`, `title`, `image`, `url`, `target`, `html`, `status`, `sort`, `click`, `type`, `created_at`, `updated_at`) VALUES
	('9aaaab35-9ee6-4e19-877e-905481f47b2c', 'Banner home 1 (grakan-light)', '/data/banner/banner-home-1.jpg', NULL, '_self', '', 1, 0, 0, 'banner', '2023-11-21 21:47:55', '2023-11-21 21:47:55'),
	('9aaaab35-a08e-4d39-940e-97e8c1358cf7', 'Banner home 2 (grakan-light)', '/data/banner/banner-home-2.jpg', NULL, '_self', '', 1, 0, 0, 'banner', '2023-11-21 21:47:55', '2023-11-21 21:47:55'),
	('9aaaab35-a228-4bf8-bbfb-73e5615cf990', 'Banner breadcrumb (grakan-light)', '/data/banner/breadcrumb.jpg', NULL, '_self', '', 1, 0, 0, 'breadcrumb', '2023-11-21 21:47:55', '2023-11-21 21:47:55'),
	('9aaaab35-a397-455f-a63e-bfe6b7de54f7', 'Banner store (grakan-light)', '/data/banner/banner-store.jpg', NULL, '_self', '', 1, 0, 0, 'banner-store', '2023-11-21 21:47:55', '2023-11-21 21:47:55'),
	('9aaaab37-787e-4587-844f-52b3b1d2d464', 'Banner home 1 (grakan-light)', '/data/banner/banner-home-1.jpg', NULL, '_self', '<h1 class="swiper-title-1" data-caption-animate="fadeScale" data-caption-delay="100">Top-notch Furniture</h1><p class="biggest text-white-70" data-caption-animate="fadeScale" data-caption-delay="200">Sofa Store provides the best furniture and accessories for homes and offices.</p><div class="button-wrap" data-caption-animate="fadeInUp" data-caption-delay="300"> <span class="button button-zachem-tak-delat button-white button-zakaria"> Shop now</span> </div>', 1, 0, 0, 'banner', NULL, NULL),
	('9aaaab37-7887-4d25-9559-7d1bde707b15', 'Banner home 2 (grakan-light)', '/data/banner/banner-home-2.jpg', NULL, '_self', '<h1 class="swiper-title-1" data-caption-animate="fadeScale" data-caption-delay="100">Top-notch Furniture</h1><p class="biggest text-white-70" data-caption-animate="fadeScale" data-caption-delay="200">Sofa Store provides the best furniture and accessories for homes and offices.</p><div class="button-wrap" data-caption-animate="fadeInUp" data-caption-delay="300"> <span class="button button-zachem-tak-delat button-white button-zakaria"> Shop now</span> </div>', 1, 0, 0, 'banner', NULL, NULL),
	('9aaaab37-788c-417b-91c6-91fe6146141e', 'Banner breadcrumb (grakan-light)', '/data/banner/breadcrumb.jpg', NULL, '_self', '', 1, 0, 0, 'breadcrumb', NULL, NULL),
	('9aaaab37-7890-4ccf-9d00-13c2a91701f8', 'Banner store (grakan-light)', '/data/banner/banner-store.jpg', NULL, '_self', '', 1, 0, 0, 'banner-store', NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_banner` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_banner_store
CREATE TABLE IF NOT EXISTS `gc_shop_banner_store` (
  `banner_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`banner_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_banner_store: ~8 rows (approximately)
DELETE FROM `gc_shop_banner_store`;
/*!40000 ALTER TABLE `gc_shop_banner_store` DISABLE KEYS */;
INSERT INTO `gc_shop_banner_store` (`banner_id`, `store_id`) VALUES
	('9aaaab35-9ee6-4e19-877e-905481f47b2c', '1'),
	('9aaaab35-a08e-4d39-940e-97e8c1358cf7', '1'),
	('9aaaab35-a228-4bf8-bbfb-73e5615cf990', '1'),
	('9aaaab35-a397-455f-a63e-bfe6b7de54f7', '1'),
	('9aaaab37-787e-4587-844f-52b3b1d2d464', '1'),
	('9aaaab37-7887-4d25-9559-7d1bde707b15', '1'),
	('9aaaab37-788c-417b-91c6-91fe6146141e', '1'),
	('9aaaab37-7890-4ccf-9d00-13c2a91701f8', '1');
/*!40000 ALTER TABLE `gc_shop_banner_store` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_banner_type
CREATE TABLE IF NOT EXISTS `gc_shop_banner_type` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_shop_banner_type_code_unique` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_banner_type: ~7 rows (approximately)
DELETE FROM `gc_shop_banner_type`;
/*!40000 ALTER TABLE `gc_shop_banner_type` DISABLE KEYS */;
INSERT INTO `gc_shop_banner_type` (`id`, `code`, `name`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `gc_shop_banner_type` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_brand
CREATE TABLE IF NOT EXISTS `gc_shop_brand` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_brand_alias_index` (`alias`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_brand: ~9 rows (approximately)
DELETE FROM `gc_shop_brand`;
/*!40000 ALTER TABLE `gc_shop_brand` DISABLE KEYS */;
INSERT INTO `gc_shop_brand` (`id`, `name`, `alias`, `image`, `url`, `status`, `sort`, `created_at`, `updated_at`) VALUES
	('9aaaab37-8088-4ecd-a363-50210705b610', 'DaNang', 'danang', '/data/brand/acer.png', NULL, 1, 0, NULL, NULL),
	('9aaaab37-8097-449b-8e70-e1a3c09cdacc', 'SaiGon', 'saigon', '/data/brand/assus.png', NULL, 1, 0, NULL, NULL),
	('9aaaab37-809e-4184-bd21-2fa9d013d1f8', 'HaNoi', 'hanoi', '/data/brand/casio.png', NULL, 1, 0, NULL, NULL),
	('9aaaab37-80a3-4180-a64d-c1367cd8c097', 'BenTre', 'bentre', '/data/brand/dell.png', NULL, 1, 0, NULL, NULL),
	('9aaaab37-80ab-4b54-abf9-7f6ecdb06410', 'NgheAn', 'nghean', '/data/brand/microsoft.png', NULL, 1, 0, NULL, NULL),
	('9aaaab37-80ba-458b-aba3-3dbae8224915', 'LongAn', 'longan', '/data/brand/nokia.png', NULL, 1, 0, NULL, NULL),
	('9aaaab37-80c0-4c27-b7bb-cdd7e3f30346', 'CaMau', 'camau', '/data/brand/panasonic.png', NULL, 1, 0, NULL, NULL),
	('9aaaab37-80cf-4962-b4dd-41473a4ddd89', 'HaGiang', 'hagiang', '/data/brand/sharp.png', NULL, 1, 0, NULL, NULL),
	('9aaaab37-80e0-4572-a736-a540aac3259b', 'ThanhHoa', 'thanhhoa', '/data/brand/vaio.png', NULL, 1, 0, NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_brand` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_brand_store
CREATE TABLE IF NOT EXISTS `gc_shop_brand_store` (
  `brand_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`brand_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_brand_store: ~9 rows (approximately)
DELETE FROM `gc_shop_brand_store`;
/*!40000 ALTER TABLE `gc_shop_brand_store` DISABLE KEYS */;
INSERT INTO `gc_shop_brand_store` (`brand_id`, `store_id`) VALUES
	('9aaaab37-8088-4ecd-a363-50210705b610', '1'),
	('9aaaab37-8097-449b-8e70-e1a3c09cdacc', '1'),
	('9aaaab37-809e-4184-bd21-2fa9d013d1f8', '1'),
	('9aaaab37-80a3-4180-a64d-c1367cd8c097', '1'),
	('9aaaab37-80ab-4b54-abf9-7f6ecdb06410', '1'),
	('9aaaab37-80ba-458b-aba3-3dbae8224915', '1'),
	('9aaaab37-80c0-4c27-b7bb-cdd7e3f30346', '1'),
	('9aaaab37-80cf-4962-b4dd-41473a4ddd89', '1'),
	('9aaaab37-80e0-4572-a736-a540aac3259b', '1');
/*!40000 ALTER TABLE `gc_shop_brand_store` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_category
CREATE TABLE IF NOT EXISTS `gc_shop_category` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `alias` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_category_alias_index` (`alias`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_category: ~27 rows (approximately)
DELETE FROM `gc_shop_category`;
/*!40000 ALTER TABLE `gc_shop_category` DISABLE KEYS */;
INSERT INTO `gc_shop_category` (`id`, `image`, `alias`, `parent`, `top`, `status`, `sort`, `created_at`, `updated_at`) VALUES
	('9aaaab37-7b16-4fb8-b590-583a2c3c39e9', '/data/category/laptop1.png', 'am-thuc', '0', 1, 1, 0, NULL, NULL),
	('9aaaab37-7b1f-48c8-b649-4ebd57e6ffdc', '/data/category/headphone1.png', 'du-lich', '0', 1, 1, 1, NULL, NULL),
	('9aaaab37-7b24-4443-9365-db444cefa28b', '/data/category/phone1.png', 'my-nghe', '0', 1, 1, 2, NULL, NULL),
	('9aaaab37-7b29-4d64-9bfa-b853ffadbda1', '/data/category/camera1.png', 'van-hoa', '0', 1, 1, 3, NULL, NULL),
	('9aaaab37-7b2d-4368-b2ff-3e0c7078e9e3', '/data/category/wifi1.png', 'the-thao', '0', 1, 1, 4, NULL, NULL),
	('9aaaab37-7b31-4c24-a2e6-dbfcd2055e99', '/data/category/iot1.png', 'cong-nghe', '0', 1, 1, 5, NULL, NULL),
	('9aaaab37-7b35-4f14-b8ac-cc5448097fa6', '/data/category/usb1.png', 'ky-thuat', '0', 1, 1, 6, NULL, NULL),
	('9aaaab37-7b39-4bfe-a8bb-452bf90e7f0f', '/data/category/service1.png', 'dich-vu', '0', 1, 1, 7, NULL, NULL),
	('9aaaab37-7b3f-4360-af44-31a15e369d77', '/data/category/speaker1.png', 'banh-my-sai-gon', '9aaaab37-7b2d-4368-b2ff-3e0c7078e9e3', 0, 1, 0, NULL, NULL),
	('9aaaab37-7b48-40c2-8f76-cc02ecdfab7f', '/data/category/laptop6.png', 'gom-bat-trang', '9aaaab37-7b29-4d64-9bfa-b853ffadbda1', 0, 1, 0, NULL, NULL),
	('9aaaab37-7b4e-4c96-86bc-ab82947f6fc3', '/data/category/cpu1.png', 'dan-ca-quan-ho', '9aaaab37-7b31-4c24-a2e6-dbfcd2055e99', 0, 1, 0, NULL, NULL),
	('9aaaab37-7b56-471c-8777-5fb101429687', '/data/category/cpu2.png', 'don-ca-tai-tu', '9aaaab37-7b31-4c24-a2e6-dbfcd2055e99', 0, 1, 0, NULL, NULL),
	('9aaaab37-7b5c-4166-9d21-63e6a4698be9', '/data/category/blueetooth2.png', 'nem-chua', '9aaaab37-7b24-4443-9365-db444cefa28b', 1, 1, 7, NULL, NULL),
	('9aaaab37-7b61-45a7-b64a-3a8306176912', '/data/category/wifi2.png', 'toi-ly-son', '9aaaab37-7b2d-4368-b2ff-3e0c7078e9e3', 1, 1, 20, NULL, NULL),
	('9aaaab37-7b6c-445f-99b9-ade62188c7fb', '/data/category/headphone3.png', 'phong-nha-kebang', '9aaaab37-7b1f-48c8-b649-4ebd57e6ffdc', 0, 1, 0, NULL, NULL),
	('9aaaab37-7b73-4e7b-b060-b0df0fee39fd', '/data/category/laptop2.png', 'pho-nam-dinh', '9aaaab37-7b16-4fb8-b590-583a2c3c39e9', 0, 1, 0, NULL, NULL),
	('9aaaab37-7b79-4513-9afb-27bda061aedc', '/data/category/laptop3.png', 'com-lang-vong', '9aaaab37-7b16-4fb8-b590-583a2c3c39e9', 0, 1, 0, NULL, NULL),
	('9aaaab37-7b7e-459f-9ba2-a5576631db8f', '/data/category/laptop4.png', 'bun-cha-hanoi', '9aaaab37-7b16-4fb8-b590-583a2c3c39e9', 0, 1, 0, NULL, NULL),
	('9aaaab37-7b84-4a9d-ace8-1c045829bbd9', '/data/category/laptop5.png', 'com-tam-an-giang', '9aaaab37-7b31-4c24-a2e6-dbfcd2055e99', 0, 1, 0, NULL, NULL),
	('9aaaab37-7b89-4fb8-af4f-9cbcda2eba80', '/data/category/headphone2.png', 'vinh-ha-long', '9aaaab37-7b1f-48c8-b649-4ebd57e6ffdc', 0, 1, 0, NULL, NULL),
	('9aaaab37-7b8e-4375-963d-d41ffb1998ab', '/data/category/camera1.png', 'lua-ha-dong', '9aaaab37-7b29-4d64-9bfa-b853ffadbda1', 0, 1, 0, NULL, NULL),
	('9aaaab37-7b92-4441-93af-da9d5296dac5', '/data/category/camera2.png', 'non-quai-thao', '9aaaab37-7b29-4d64-9bfa-b853ffadbda1', 0, 1, 0, NULL, NULL),
	('9aaaab37-7b99-4d3f-af82-e49a9f78ba7f', '/data/category/monitor2.png', 'tranh-dong-ho', '9aaaab37-7b24-4443-9365-db444cefa28b', 0, 1, 0, NULL, NULL),
	('9aaaab37-7bbc-4c4e-b96b-65f94f905b30', '/data/category/monitor1.png', 'trai-cay-nam-bo', '9aaaab37-7b24-4443-9365-db444cefa28b', 0, 1, 0, NULL, NULL),
	('9aaaab37-7bc2-41bb-9e78-fd7c295e6a39', '/data/category/phone2.png', 'chieu-coi-nga-son', '9aaaab37-7b24-4443-9365-db444cefa28b', 0, 1, 0, NULL, NULL),
	('9aaaab37-7bc7-473b-9363-8bfe3eb9f539', '/data/category/server1.png', 'nhac-co-truyen', '9aaaab37-7b1f-48c8-b649-4ebd57e6ffdc', 0, 1, 0, NULL, NULL),
	('9aaaab37-7bcb-4b9e-943d-412cd30d2528', '/data/category/print1.png', 'con-dao', '9aaaab37-7b1f-48c8-b649-4ebd57e6ffdc', 1, 1, 10, NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_category` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_category_description
CREATE TABLE IF NOT EXISTS `gc_shop_category_description` (
  `category_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lang` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `keyword` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  UNIQUE KEY `gc_shop_category_description_category_id_lang_unique` (`category_id`,`lang`),
  KEY `gc_shop_category_description_lang_index` (`lang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_category_description: ~54 rows (approximately)
DELETE FROM `gc_shop_category_description`;
/*!40000 ALTER TABLE `gc_shop_category_description` DISABLE KEYS */;
INSERT INTO `gc_shop_category_description` (`category_id`, `lang`, `title`, `keyword`, `description`) VALUES
	('9aaaab37-7b16-4fb8-b590-583a2c3c39e9', 'en', 'Am Thuc', NULL, NULL),
	('9aaaab37-7b16-4fb8-b590-583a2c3c39e9', 'vi', 'Am Thuc', NULL, NULL),
	('9aaaab37-7b1f-48c8-b649-4ebd57e6ffdc', 'en', 'Du Lich', NULL, NULL),
	('9aaaab37-7b1f-48c8-b649-4ebd57e6ffdc', 'vi', 'Du Lich', NULL, NULL),
	('9aaaab37-7b24-4443-9365-db444cefa28b', 'en', 'My Nghe', NULL, NULL),
	('9aaaab37-7b24-4443-9365-db444cefa28b', 'vi', 'My Nghe', NULL, NULL),
	('9aaaab37-7b29-4d64-9bfa-b853ffadbda1', 'en', 'Van Hoa', NULL, NULL),
	('9aaaab37-7b29-4d64-9bfa-b853ffadbda1', 'vi', 'Van Hoa', NULL, NULL),
	('9aaaab37-7b2d-4368-b2ff-3e0c7078e9e3', 'en', 'The Thao', NULL, NULL),
	('9aaaab37-7b2d-4368-b2ff-3e0c7078e9e3', 'vi', 'The Thao', NULL, NULL),
	('9aaaab37-7b31-4c24-a2e6-dbfcd2055e99', 'en', 'Cong Nghe', NULL, NULL),
	('9aaaab37-7b31-4c24-a2e6-dbfcd2055e99', 'vi', 'Cong Nghe', NULL, NULL),
	('9aaaab37-7b35-4f14-b8ac-cc5448097fa6', 'en', 'Ky Thuat', NULL, NULL),
	('9aaaab37-7b35-4f14-b8ac-cc5448097fa6', 'vi', 'Ky Thuat', NULL, NULL),
	('9aaaab37-7b39-4bfe-a8bb-452bf90e7f0f', 'en', 'Dich Vu', NULL, NULL),
	('9aaaab37-7b39-4bfe-a8bb-452bf90e7f0f', 'vi', 'Dich Vu', NULL, NULL),
	('9aaaab37-7b3f-4360-af44-31a15e369d77', 'en', 'Banh My Sai Gon', NULL, NULL),
	('9aaaab37-7b3f-4360-af44-31a15e369d77', 'vi', 'Banh My Sai Gon', NULL, NULL),
	('9aaaab37-7b48-40c2-8f76-cc02ecdfab7f', 'en', 'Gom Bat Trang', NULL, NULL),
	('9aaaab37-7b48-40c2-8f76-cc02ecdfab7f', 'vi', 'Gom Bat Trang', NULL, NULL),
	('9aaaab37-7b4e-4c96-86bc-ab82947f6fc3', 'en', 'Dan Ca Quan Ho', NULL, NULL),
	('9aaaab37-7b4e-4c96-86bc-ab82947f6fc3', 'vi', 'Dan Ca Quan Ho', NULL, NULL),
	('9aaaab37-7b56-471c-8777-5fb101429687', 'en', 'Don Ca Tai Tu', NULL, NULL),
	('9aaaab37-7b56-471c-8777-5fb101429687', 'vi', 'Don Ca Tai Tu', NULL, NULL),
	('9aaaab37-7b5c-4166-9d21-63e6a4698be9', 'en', 'Nem Chua', NULL, NULL),
	('9aaaab37-7b5c-4166-9d21-63e6a4698be9', 'vi', 'Nem Chua', NULL, NULL),
	('9aaaab37-7b61-45a7-b64a-3a8306176912', 'en', 'Toi Ly Son', NULL, NULL),
	('9aaaab37-7b61-45a7-b64a-3a8306176912', 'vi', 'Toi Ly Son', NULL, NULL),
	('9aaaab37-7b6c-445f-99b9-ade62188c7fb', 'en', 'Phong Nha Kebang', NULL, NULL),
	('9aaaab37-7b6c-445f-99b9-ade62188c7fb', 'vi', 'Phong Nha Kebang', NULL, NULL),
	('9aaaab37-7b73-4e7b-b060-b0df0fee39fd', 'en', 'Pho Nam Dinh', NULL, NULL),
	('9aaaab37-7b73-4e7b-b060-b0df0fee39fd', 'vi', 'Pho Nam Dinh', NULL, NULL),
	('9aaaab37-7b79-4513-9afb-27bda061aedc', 'en', 'Com Lang Vong', NULL, NULL),
	('9aaaab37-7b79-4513-9afb-27bda061aedc', 'vi', 'Com Lang Vong', NULL, NULL),
	('9aaaab37-7b7e-459f-9ba2-a5576631db8f', 'en', 'Bun Cha Hanoi', NULL, NULL),
	('9aaaab37-7b7e-459f-9ba2-a5576631db8f', 'vi', 'Bun Cha Hanoi', NULL, NULL),
	('9aaaab37-7b84-4a9d-ace8-1c045829bbd9', 'en', 'Com Tam An Giang', NULL, NULL),
	('9aaaab37-7b84-4a9d-ace8-1c045829bbd9', 'vi', 'Com Tam An Giang', NULL, NULL),
	('9aaaab37-7b89-4fb8-af4f-9cbcda2eba80', 'en', 'Vinh Ha Long', NULL, NULL),
	('9aaaab37-7b89-4fb8-af4f-9cbcda2eba80', 'vi', 'Vinh Ha Long', NULL, NULL),
	('9aaaab37-7b8e-4375-963d-d41ffb1998ab', 'en', 'Lua Ha Dong', NULL, NULL),
	('9aaaab37-7b8e-4375-963d-d41ffb1998ab', 'vi', 'Lua Ha Dong', NULL, NULL),
	('9aaaab37-7b92-4441-93af-da9d5296dac5', 'en', 'Non Quai Thao', NULL, NULL),
	('9aaaab37-7b92-4441-93af-da9d5296dac5', 'vi', 'Non Quai Thao', NULL, NULL),
	('9aaaab37-7b99-4d3f-af82-e49a9f78ba7f', 'en', 'Tranh Dong Ho', NULL, NULL),
	('9aaaab37-7b99-4d3f-af82-e49a9f78ba7f', 'vi', 'Tranh Dong Ho', NULL, NULL),
	('9aaaab37-7bbc-4c4e-b96b-65f94f905b30', 'en', 'Trai Cay Nam Bo', NULL, NULL),
	('9aaaab37-7bbc-4c4e-b96b-65f94f905b30', 'vi', 'Trai Cay Nam Bo', NULL, NULL),
	('9aaaab37-7bc2-41bb-9e78-fd7c295e6a39', 'en', 'Chieu Coi Nga Son', NULL, NULL),
	('9aaaab37-7bc2-41bb-9e78-fd7c295e6a39', 'vi', 'Chieu Coi Nga Son', NULL, NULL),
	('9aaaab37-7bc7-473b-9363-8bfe3eb9f539', 'en', 'Nhac Co Truyen', NULL, NULL),
	('9aaaab37-7bc7-473b-9363-8bfe3eb9f539', 'vi', 'Nhac Co Truyen', NULL, NULL),
	('9aaaab37-7bcb-4b9e-943d-412cd30d2528', 'en', 'Con Dao', NULL, NULL),
	('9aaaab37-7bcb-4b9e-943d-412cd30d2528', 'vi', 'Con Dao', NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_category_description` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_category_store
CREATE TABLE IF NOT EXISTS `gc_shop_category_store` (
  `category_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_category_store: ~27 rows (approximately)
DELETE FROM `gc_shop_category_store`;
/*!40000 ALTER TABLE `gc_shop_category_store` DISABLE KEYS */;
INSERT INTO `gc_shop_category_store` (`category_id`, `store_id`) VALUES
	('9aaaab37-7b16-4fb8-b590-583a2c3c39e9', '1'),
	('9aaaab37-7b1f-48c8-b649-4ebd57e6ffdc', '1'),
	('9aaaab37-7b24-4443-9365-db444cefa28b', '1'),
	('9aaaab37-7b29-4d64-9bfa-b853ffadbda1', '1'),
	('9aaaab37-7b2d-4368-b2ff-3e0c7078e9e3', '1'),
	('9aaaab37-7b31-4c24-a2e6-dbfcd2055e99', '1'),
	('9aaaab37-7b35-4f14-b8ac-cc5448097fa6', '1'),
	('9aaaab37-7b39-4bfe-a8bb-452bf90e7f0f', '1'),
	('9aaaab37-7b3f-4360-af44-31a15e369d77', '1'),
	('9aaaab37-7b48-40c2-8f76-cc02ecdfab7f', '1'),
	('9aaaab37-7b4e-4c96-86bc-ab82947f6fc3', '1'),
	('9aaaab37-7b56-471c-8777-5fb101429687', '1'),
	('9aaaab37-7b5c-4166-9d21-63e6a4698be9', '1'),
	('9aaaab37-7b61-45a7-b64a-3a8306176912', '1'),
	('9aaaab37-7b6c-445f-99b9-ade62188c7fb', '1'),
	('9aaaab37-7b73-4e7b-b060-b0df0fee39fd', '1'),
	('9aaaab37-7b79-4513-9afb-27bda061aedc', '1'),
	('9aaaab37-7b7e-459f-9ba2-a5576631db8f', '1'),
	('9aaaab37-7b84-4a9d-ace8-1c045829bbd9', '1'),
	('9aaaab37-7b89-4fb8-af4f-9cbcda2eba80', '1'),
	('9aaaab37-7b8e-4375-963d-d41ffb1998ab', '1'),
	('9aaaab37-7b92-4441-93af-da9d5296dac5', '1'),
	('9aaaab37-7b99-4d3f-af82-e49a9f78ba7f', '1'),
	('9aaaab37-7bbc-4c4e-b96b-65f94f905b30', '1'),
	('9aaaab37-7bc2-41bb-9e78-fd7c295e6a39', '1'),
	('9aaaab37-7bc7-473b-9363-8bfe3eb9f539', '1'),
	('9aaaab37-7bcb-4b9e-943d-412cd30d2528', '1');
/*!40000 ALTER TABLE `gc_shop_category_store` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_country
CREATE TABLE IF NOT EXISTS `gc_shop_country` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_shop_country_code_unique` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=246 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_country: ~245 rows (approximately)
DELETE FROM `gc_shop_country`;
/*!40000 ALTER TABLE `gc_shop_country` DISABLE KEYS */;
INSERT INTO `gc_shop_country` (`id`, `code`, `name`) VALUES
	(1, 'AL', 'Albania'),
	(2, 'DZ', 'Algeria'),
	(3, 'DS', 'American Samoa'),
	(4, 'AD', 'Andorra'),
	...
	(244, 'ZM', 'Zambia'),
	(245, 'ZW', 'Zimbabwe');
/*!40000 ALTER TABLE `gc_shop_country` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_currency
CREATE TABLE IF NOT EXISTS `gc_shop_currency` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `symbol_first` tinyint NOT NULL DEFAULT '0',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_shop_currency_code_unique` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_currency: ~2 rows (approximately)
DELETE FROM `gc_shop_currency`;
/*!40000 ALTER TABLE `gc_shop_currency` DISABLE KEYS */;
INSERT INTO `gc_shop_currency` (`id`, `name`, `code`, `symbol`, `exchange_rate`, `precision`, `symbol_first`, `thousands`, `status`, `sort`, `created_at`, `updated_at`) VALUES
	(1, 'USD Dola', 'USD', '$', 1.00, 2, 1, ',', 1, 0, NULL, NULL),
	(2, 'VietNam Dong', 'VND', '₫', 20000.00, 0, 0, ',', 1, 1, NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_currency` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_customer
CREATE TABLE IF NOT EXISTS `gc_shop_customer` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `email` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sex` tinyint DEFAULT NULL COMMENT '0:women, 1:men',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_shop_customer_email_provider_provider_id_unique` (`email`,`provider`,`provider_id`),
  KEY `gc_shop_customer_address_id_index` (`address_id`),
  KEY `gc_shop_customer_store_id_index` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_customer: ~0 rows (approximately)
DELETE FROM `gc_shop_customer`;
/*!40000 ALTER TABLE `gc_shop_customer` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_shop_customer` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_customer_address
CREATE TABLE IF NOT EXISTS `gc_shop_customer_address` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_customer_address_customer_id_index` (`customer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_customer_address: ~0 rows (approximately)
DELETE FROM `gc_shop_customer_address`;
/*!40000 ALTER TABLE `gc_shop_customer_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_shop_customer_address` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_custom_field
CREATE TABLE IF NOT EXISTS `gc_shop_custom_field` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_custom_field_type_index` (`type`),
  KEY `gc_shop_custom_field_code_index` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_custom_field: ~0 rows (approximately)
DELETE FROM `gc_shop_custom_field`;
/*!40000 ALTER TABLE `gc_shop_custom_field` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_shop_custom_field` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_custom_field_detail
CREATE TABLE IF NOT EXISTS `gc_shop_custom_field_detail` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_custom_field_detail_custom_field_id_index` (`custom_field_id`),
  KEY `gc_shop_custom_field_detail_rel_id_index` (`rel_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_custom_field_detail: ~0 rows (approximately)
DELETE FROM `gc_shop_custom_field_detail`;
/*!40000 ALTER TABLE `gc_shop_custom_field_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_shop_custom_field_detail` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_email_template
CREATE TABLE IF NOT EXISTS `gc_shop_email_template` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gc_shop_layout_page` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_shop_layout_page_key_unique` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_layout_page: ~18 rows (approximately)
DELETE FROM `gc_shop_layout_page`;
/*!40000 ALTER TABLE `gc_shop_layout_page` DISABLE KEYS */;
INSERT INTO `gc_shop_layout_page` (`id`, `key`, `name`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `gc_shop_layout_page` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_layout_position
CREATE TABLE IF NOT EXISTS `gc_shop_layout_position` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_shop_layout_position_key_unique` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_layout_position: ~6 rows (approximately)
DELETE FROM `gc_shop_layout_position`;
/*!40000 ALTER TABLE `gc_shop_layout_position` DISABLE KEYS */;
INSERT INTO `gc_shop_layout_position` (`id`, `key`, `name`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `gc_shop_layout_position` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_length
CREATE TABLE IF NOT EXISTS `gc_shop_length` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_shop_length_name_unique` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_length: ~4 rows (approximately)
DELETE FROM `gc_shop_length`;
/*!40000 ALTER TABLE `gc_shop_length` DISABLE KEYS */;
INSERT INTO `gc_shop_length` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES
	(1, 'mm', 'Millimeter', NULL, NULL),
	(2, 'cm', 'Centimeter', NULL, NULL),
	(3, 'm', 'Meter ', NULL, NULL),
	(4, 'in', 'Inch ', NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_length` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_link
CREATE TABLE IF NOT EXISTS `gc_shop_link` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `url` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table grakan.gc_shop_link: ~11 rows (approximately)
DELETE FROM `gc_shop_link`;
/*!40000 ALTER TABLE `gc_shop_link` DISABLE KEYS */;
INSERT INTO `gc_shop_link` (`id`, `name`, `url`, `target`, `group`, `module`, `type`, `collection_id`, `status`, `sort`, `created_at`, `updated_at`) VALUES
	...
	('3', 'About us', 'https://grakan.org/en/about.html', '_self', 'menu', NULL, NULL, '2', 1, 10, NULL, NULL),
	('4', 'Github', 'https://github.com/grakan/grakan', '_self', 'menu', NULL, NULL, '2', 1, 20, NULL, NULL),
	('9aaaab35-9a2c-4dcb-a361-c6f4bfac57ac', 'front.home', 'route::home', '_self', 'menu', '', NULL, NULL, 1, 10, NULL, NULL),
	('9aaaab35-9a3f-40aa-91b2-3dce9246e6f6', 'front.shop', 'route::shop', '_self', 'menu', '', NULL, NULL, 1, 20, NULL, NULL),
	('9aaaab35-9a50-4f74-85fb-50d361581713', 'front.blog', 'route::news', '_self', 'menu', '', NULL, NULL, 1, 30, NULL, NULL),
	('9aaaab35-9a63-4779-a5af-aa75ff33b107', 'front.contact', 'route::contact', '_self', 'menu', '', NULL, NULL, 1, 40, NULL, NULL),
	('9aaaab35-9a74-48f0-9333-3c990011d839', 'front.my_profile', 'route::login', '_self', 'footer', '', NULL, NULL, 1, 60, NULL, NULL),
	('9aaaab35-9a7b-436d-a4be-aff2986fbcf2', 'front.compare_page', 'route::compare', '_self', 'footer', '', NULL, NULL, 1, 70, NULL, NULL),
	('9aaaab35-9a82-427e-b5e9-aff70fa919d9', 'front.wishlist_page', 'route::wishlist', '_self', 'footer', '', NULL, NULL, 1, 80, NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_link` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_link_group
CREATE TABLE IF NOT EXISTS `gc_shop_link_group` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_shop_link_group_code_unique` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_link_group: ~7 rows (approximately)
DELETE FROM `gc_shop_link_group`;
/*!40000 ALTER TABLE `gc_shop_link_group` DISABLE KEYS */;
INSERT INTO `gc_shop_link_group` (`id`, `code`, `name`, `created_at`, `updated_at`) VALUES
...
/*!40000 ALTER TABLE `gc_shop_link_group` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_link_store
CREATE TABLE IF NOT EXISTS `gc_shop_link_store` (
  `link_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`link_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_link_store: ~11 rows (approximately)
DELETE FROM `gc_shop_link_store`;
/*!40000 ALTER TABLE `gc_shop_link_store` DISABLE KEYS */;
INSERT INTO `gc_shop_link_store` (`link_id`, `store_id`) VALUES
	('1', '1'),
	('2', '1'),
	('3', '1'),
	('4', '1'),
	('9aaaab35-9a2c-4dcb-a361-c6f4bfac57ac', '1'),
	('9aaaab35-9a3f-40aa-91b2-3dce9246e6f6', '1'),
	('9aaaab35-9a50-4f74-85fb-50d361581713', '1'),
	('9aaaab35-9a63-4779-a5af-aa75ff33b107', '1'),
	('9aaaab35-9a74-48f0-9333-3c990011d839', '1'),
	('9aaaab35-9a7b-436d-a4be-aff2986fbcf2', '1'),
	('9aaaab35-9a82-427e-b5e9-aff70fa919d9', '1');
/*!40000 ALTER TABLE `gc_shop_link_store` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_news
CREATE TABLE IF NOT EXISTS `gc_shop_news` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_news_alias_index` (`alias`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_news: ~6 rows (approximately)
DELETE FROM `gc_shop_news`;
/*!40000 ALTER TABLE `gc_shop_news` DISABLE KEYS */;
INSERT INTO `gc_shop_news` (`id`, `image`, `alias`, `sort`, `status`, `created_at`, `updated_at`) VALUES
	('9aaaab37-7321-42c7-986a-e5809c61d950', '/data/content/blog-1.jpg', 'cau-vang', 0, 1, '2023-11-21 21:47:56', NULL),
	('9aaaab37-7492-4543-9b1e-8acf0b312f68', '/data/content/blog-2.jpg', 'vinh-ha-long', 0, 1, '2023-11-21 21:47:56', NULL),
	('9aaaab37-7499-434e-b95f-3016197199dd', '/data/content/blog-3.jpg', 'hang-son-doong', 0, 1, '2023-11-21 21:47:56', NULL),
	('9aaaab37-749e-4bbf-b53d-721fd451ed0e', '/data/content/blog-4.jpg', 'trang-an', 0, 1, '2023-11-21 21:47:56', NULL),
	('9aaaab37-74a3-40e6-b4bd-0bccf0f957de', '/data/content/blog-5.jpg', 'ruong-bac-thang-ha-giang', 0, 1, '2023-11-21 21:47:56', NULL),
	('9aaaab37-74a8-480c-ab83-d7367fc22a6f', '/data/content/blog-6.jpg', 'thi-tran-sapa', 0, 1, '2023-11-21 21:47:56', NULL);
/*!40000 ALTER TABLE `gc_shop_news` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_news_description
CREATE TABLE IF NOT EXISTS `gc_shop_news_description` (
  ...
  UNIQUE KEY `gc_shop_news_description_news_id_lang_unique` (`news_id`,`lang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_news_description: ~12 rows (approximately)
DELETE FROM `gc_shop_news_description`;
/*!40000 ALTER TABLE `gc_shop_news_description` DISABLE KEYS */;
INSERT INTO `gc_shop_news_description` (`news_id`, `lang`, `title`, `keyword`, `description`, `content`) VALUES
	('9aaaab37-7321-42c7-986a-e5809c61d950', 'en', 'Cau Vang', NULL, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-7321-42c7-986a-e5809c61d950', 'vi', 'Cau Vang', NULL, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	...
	('9aaaab37-7499-434e-b95f-3016197199dd', 'en', 'Hang Son Doong', NULL, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-7499-434e-b95f-3016197199dd', 'vi', 'Hang Son Doong', NULL, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-749e-4bbf-b53d-721fd451ed0e', 'en', 'Trang An', NULL, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-749e-4bbf-b53d-721fd451ed0e', 'vi', 'Trang An', NULL, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-74a3-40e6-b4bd-0bccf0f957de', 'en', 'Ruong Bac Thang Ha Giang', NULL, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-74a3-40e6-b4bd-0bccf0f957de', 'vi', 'Ruong Bac Thang Ha Giang', NULL, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-74a8-480c-ab83-d7367fc22a6f', 'en', 'Thi Tran Sapa', NULL, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-74a8-480c-ab83-d7367fc22a6f', 'vi', 'Thi Tran Sapa', NULL, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>');
/*!40000 ALTER TABLE `gc_shop_news_description` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_news_store
CREATE TABLE IF NOT EXISTS `gc_shop_news_store` (
  `news_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`news_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_news_store: ~6 rows (approximately)
DELETE FROM `gc_shop_news_store`;
/*!40000 ALTER TABLE `gc_shop_news_store` DISABLE KEYS */;
INSERT INTO `gc_shop_news_store` (`news_id`, `store_id`) VALUES
	('9aaaab37-7321-42c7-986a-e5809c61d950', '1'),
	('9aaaab37-7492-4543-9b1e-8acf0b312f68', '1'),
	('9aaaab37-7499-434e-b95f-3016197199dd', '1'),
	('9aaaab37-749e-4bbf-b53d-721fd451ed0e', '1'),
	('9aaaab37-74a3-40e6-b4bd-0bccf0f957de', '1'),
	('9aaaab37-74a8-480c-ab83-d7367fc22a6f', '1');
/*!40000 ALTER TABLE `gc_shop_news_store` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_order
CREATE TABLE IF NOT EXISTS `gc_shop_order` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_order_customer_id_index` (`customer_id`),
  KEY `gc_shop_order_device_type_index` (`device_type`),
  KEY `gc_shop_order_store_id_index` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_order: ~0 rows (approximately)
DELETE FROM `gc_shop_order`;
/*!40000 ALTER TABLE `gc_shop_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_shop_order` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_order_detail
CREATE TABLE IF NOT EXISTS `gc_shop_order_detail` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table grakan.gc_shop_order_detail: ~0 rows (approximately)
DELETE FROM `gc_shop_order_detail`;
/*!40000 ALTER TABLE `gc_shop_order_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_shop_order_detail` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_order_history
CREATE TABLE IF NOT EXISTS `gc_shop_order_history` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table grakan.gc_shop_order_history: ~0 rows (approximately)
DELETE FROM `gc_shop_order_history`;
/*!40000 ALTER TABLE `gc_shop_order_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_shop_order_history` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_order_status
CREATE TABLE IF NOT EXISTS `gc_shop_order_status` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
-- Dumping data for table grakan.gc_shop_order_status: ~6 rows (approximately)
DELETE FROM `gc_shop_order_status`;
/*!40000 ALTER TABLE `gc_shop_order_status` DISABLE KEYS */;
INSERT INTO `gc_shop_order_status` (`id`, `name`, `created_at`, `updated_at`) VALUES
	(1, 'New', NULL, NULL),
	...
	(5, 'Done', NULL, NULL),
	(6, 'Failed', NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_order_status` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_order_total
CREATE TABLE IF NOT EXISTS `gc_shop_order_total` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_order_total_order_id_index` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_order_total: ~0 rows (approximately)
DELETE FROM `gc_shop_order_total`;
/*!40000 ALTER TABLE `gc_shop_order_total` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_shop_order_total` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_page
CREATE TABLE IF NOT EXISTS `gc_shop_page` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `alias` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` int NOT NULL DEFAULT '0',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_page_alias_index` (`alias`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_page: ~1 rows (approximately)
DELETE FROM `gc_shop_page`;
/*!40000 ALTER TABLE `gc_shop_page` DISABLE KEYS */;
INSERT INTO `gc_shop_page` (`id`, `image`, `alias`, `status`, `created_at`, `updated_at`) VALUES
	('1', '', 'about', 1, NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_page` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_page_description
CREATE TABLE IF NOT EXISTS `gc_shop_page_description` (
  ...
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content` mediumtext COLLATE utf8mb4_unicode_ci,
  UNIQUE KEY `gc_shop_page_description_page_id_lang_unique` (`page_id`,`lang`),
  KEY `gc_shop_page_description_lang_index` (`lang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_page_description: ~2 rows (approximately)
DELETE FROM `gc_shop_page_description`;
/*!40000 ALTER TABLE `gc_shop_page_description` DISABLE KEYS */;
INSERT INTO `gc_shop_page_description` (`page_id`, `lang`, `title`, `keyword`, `description`, `content`) VALUES
...
/*!40000 ALTER TABLE `gc_shop_page_description` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_page_store
CREATE TABLE IF NOT EXISTS `gc_shop_page_store` (
  `page_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`page_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_page_store: ~1 rows (approximately)
DELETE FROM `gc_shop_page_store`;
/*!40000 ALTER TABLE `gc_shop_page_store` DISABLE KEYS */;
INSERT INTO `gc_shop_page_store` (`page_id`, `store_id`) VALUES
	('1', '1');
/*!40000 ALTER TABLE `gc_shop_page_store` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_password_resets
CREATE TABLE IF NOT EXISTS `gc_shop_password_resets` (
  `email` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `token` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL,
  KEY `gc_shop_password_resets_email_index` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_password_resets: ~0 rows (approximately)
DELETE FROM `gc_shop_password_resets`;
/*!40000 ALTER TABLE `gc_shop_password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_shop_password_resets` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_payment_status
CREATE TABLE IF NOT EXISTS `gc_shop_payment_status` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
-- Dumping data for table grakan.gc_shop_payment_status: ~4 rows (approximately)
DELETE FROM `gc_shop_payment_status`;
/*!40000 ALTER TABLE `gc_shop_payment_status` DISABLE KEYS */;
INSERT INTO `gc_shop_payment_status` (`id`, `name`, `created_at`, `updated_at`) VALUES
	(1, 'Unpaid', NULL, NULL),
	(2, 'Partial payment', NULL, NULL),
	(3, 'Paid', NULL, NULL),
	(4, 'Refurn', NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_payment_status` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_product
CREATE TABLE IF NOT EXISTS `gc_shop_product` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sku` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_product_sku_index` (`sku`),
  KEY `gc_shop_product_brand_id_index` (`brand_id`),
  KEY `gc_shop_product_supplier_id_index` (`supplier_id`),
  KEY `gc_shop_product_kind_index` (`kind`),
  KEY `gc_shop_product_property_index` (`property`),
  KEY `gc_shop_product_tax_id_index` (`tax_id`),
  KEY `gc_shop_product_status_index` (`status`),
  KEY `gc_shop_product_approve_index` (`approve`),
  KEY `gc_shop_product_alias_index` (`alias`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_product: ~36 rows (approximately)
DELETE FROM `gc_shop_product`;
/*!40000 ALTER TABLE `gc_shop_product` DISABLE KEYS */;
INSERT INTO `gc_shop_product` (`id`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `image`, `brand_id`, `supplier_id`, `price`, `cost`, `stock`, `sold`, `minimum`, `weight_class`, `weight`, `length_class`, `length`, `width`, `height`, `kind`, `property`, `tax_id`, `status`, `approve`, `sort`, `view`, `alias`, `date_lastview`, `date_available`, `created_at`, `updated_at`) VALUES
	('9aaaab37-83a3-42c2-8a12-ae5c2ea15fe7', 'CU-DO-HA-TINH', NULL, NULL, NULL, NULL, NULL, '/data/product/product-1.png', '9aaaab37-809e-4184-bd21-2fa9d013d1f8', '9aaaab37-7f88-40f5-ba7a-670856402143', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'cu-do-ha-tinh', NULL, NULL, NULL, NULL),
	('9aaaab37-83ac-4861-ac51-353b5c74c21f', 'MAN-HAU-LANG-SON', NULL, NULL, NULL, NULL, NULL, '/data/product/product-2.png', '9aaaab37-809e-4184-bd21-2fa9d013d1f8', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'man-hau-lang-son', NULL, NULL, NULL, NULL),
	('9aaaab37-83b1-400e-914f-4cb6596eff24', 'BANH-GAI-TU-TRU', NULL, NULL, NULL, NULL, NULL, '/data/product/product-3.png', '9aaaab37-80c0-4c27-b7bb-cdd7e3f30346', '9aaaab37-7f88-40f5-ba7a-670856402143', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'banh-gai-tu-tru', NULL, NULL, NULL, NULL),
	('9aaaab37-83b6-41ec-b33c-d16a1cf620d3', 'BUN-BO-HUE', NULL, NULL, NULL, NULL, NULL, '/data/product/product-4.png', '9aaaab37-80c0-4c27-b7bb-cdd7e3f30346', '9aaaab37-7f88-40f5-ba7a-670856402143', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 2, 'physical', 'auto', 1, 1, 0, 0, 'bun-bo-hue', NULL, NULL, NULL, NULL),
	('9aaaab37-83bb-4097-afa8-fa30af7ad7bd', 'BANH-TRANG-TRON', NULL, NULL, NULL, NULL, NULL, '/data/product/product-5.png', '9aaaab37-809e-4184-bd21-2fa9d013d1f8', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 1, 'physical', 'auto', 1, 1, 0, 0, 'banh-trang-tron', NULL, NULL, NULL, NULL),
	('9aaaab37-83c0-4ed3-80cb-35f54a4af90e', 'MUOI-TAY-NINH', NULL, NULL, NULL, NULL, NULL, '/data/product/product-6.png', '9aaaab37-8097-449b-8e70-e1a3c09cdacc', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'muoi-tay-ninh', NULL, NULL, NULL, NULL),
	('9aaaab37-83c4-4c31-8926-586609cd35d5', 'KEO-DOI-LAC', NULL, NULL, NULL, NULL, NULL, '/data/product/product-7.png', '9aaaab37-8097-449b-8e70-e1a3c09cdacc', '9aaaab37-7f88-40f5-ba7a-670856402143', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'keo-doi-lac', NULL, NULL, NULL, NULL),
	('9aaaab37-83c9-46a1-998a-d29b021a83f3', 'SAU-RIENG-DAK-LAK', NULL, NULL, NULL, NULL, NULL, '/data/product/product-8.png', '9aaaab37-80cf-4962-b4dd-41473a4ddd89', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'sau-rieng-dak-lak', NULL, NULL, NULL, NULL),
	('9aaaab37-83cd-4024-a5cd-4de10ce3f8bb', 'DON-QUANG-NGAI', NULL, NULL, NULL, NULL, NULL, '/data/product/product-9.png', '9aaaab37-809e-4184-bd21-2fa9d013d1f8', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'don-quang-ngai', NULL, NULL, NULL, NULL),
	('9aaaab37-83d2-406f-b63a-9146597d78ed', 'BANH-KHOT-VUNG-TAU', NULL, NULL, NULL, NULL, NULL, '/data/product/product-10.png', '9aaaab37-80ba-458b-aba3-3dbae8224915', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 1, 'physical', 'auto', 1, 1, 0, 0, 'banh-khot-vung-tau', NULL, NULL, NULL, NULL),
	('9aaaab37-83d6-491b-828d-b351b171a3e7', 'CHAO-LUON-XU-NGHE', NULL, NULL, NULL, NULL, NULL, '/data/product/product-11.png', '9aaaab37-80cf-4962-b4dd-41473a4ddd89', '9aaaab37-7f88-40f5-ba7a-670856402143', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'chao-luon-xu-nghe', NULL, NULL, NULL, NULL),
	('9aaaab37-83db-4e08-861c-c33966fa737e', 'BANH-DAU-XANH-HUNG-YEN', NULL, NULL, NULL, NULL, NULL, '/data/product/product-12.png', '9aaaab37-809e-4184-bd21-2fa9d013d1f8', '9aaaab37-7f88-40f5-ba7a-670856402143', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'banh-dau-xanh-hung-yen', NULL, NULL, NULL, NULL),
	('9aaaab37-83df-4fa0-abb7-d28eceebf77a', 'HU-TIEU-NAM-VANG', NULL, NULL, NULL, NULL, NULL, '/data/product/product-13.png', '9aaaab37-80a3-4180-a64d-c1367cd8c097', '9aaaab37-7f88-40f5-ba7a-670856402143', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'hu-tieu-nam-vang', NULL, NULL, NULL, NULL),
	('9aaaab37-83e3-4876-8631-1366126a9e47', 'CANH-CHUA-CA-LOC', NULL, NULL, NULL, NULL, NULL, '/data/product/product-14.png', '9aaaab37-8097-449b-8e70-e1a3c09cdacc', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 2, 'physical', 'auto', 1, 1, 0, 0, 'canh-chua-ca-loc', NULL, NULL, NULL, NULL),
	('9aaaab37-83e7-4deb-be5d-5493eb2486d9', 'CHOM-CHOM-NHAN', NULL, NULL, NULL, NULL, NULL, '/data/product/product-15.png', '9aaaab37-80c0-4c27-b7bb-cdd7e3f30346', '9aaaab37-7f88-40f5-ba7a-670856402143', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 1, 'physical', 'auto', 1, 1, 0, 0, 'chom-chom-nhan', NULL, NULL, NULL, NULL),
	('9aaaab37-83eb-4670-9801-662c667f7e83', 'CAM-VINH-LOAI-I', NULL, NULL, NULL, NULL, NULL, '/data/product/product-16.png', '9aaaab37-80da-4b6e-a10a-21b82114c40a', '9aaaab37-7f88-40f5-ba7a-670856402143', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'cam-vinh-loai-i', NULL, NULL, NULL, NULL),
	('9aaaab37-83ef-4e35-bfea-da6c62b21b91', 'MI-QUANG', NULL, NULL, NULL, NULL, NULL, '/data/product/product-17.png', '9aaaab37-80cf-4962-b4dd-41473a4ddd89', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'mi-quang', NULL, NULL, NULL, NULL),
	('9aaaab37-83f2-4d39-9d4e-4fc3dab567d5', 'CHAO-LONG-TIET-CANH', NULL, NULL, NULL, NULL, NULL, '/data/product/product-18.png', '9aaaab37-80ab-4b54-abf9-7f6ecdb06410', '9aaaab37-7f88-40f5-ba7a-670856402143', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'chao-long-tiet-canh', NULL, NULL, NULL, NULL),
	('9aaaab37-83f6-4734-8e51-71f1b33d7e8b', 'CAM-SANH-MONG-NUOC', NULL, NULL, NULL, NULL, NULL, '/data/product/product-19.png', '9aaaab37-80c0-4c27-b7bb-cdd7e3f30346', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 2, 'physical', 'auto', 1, 1, 0, 0, 'cam-sanh-mong-nuoc', NULL, NULL, NULL, NULL),
	('9aaaab37-83fa-48b5-8c38-6d9f9e9b9338', 'XOAI-CAT-HOA-LOC', NULL, NULL, NULL, NULL, NULL, '/data/product/product-20.png', '9aaaab37-80c0-4c27-b7bb-cdd7e3f30346', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'xoai-cat-hoa-loc', NULL, NULL, NULL, NULL),
	('9aaaab37-83ff-4d72-a583-f815af568d12', 'COM-NIU-SAI-GON', NULL, NULL, NULL, NULL, NULL, '/data/product/product-21.png', '9aaaab37-80cf-4962-b4dd-41473a4ddd89', '9aaaab37-7f88-40f5-ba7a-670856402143', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'com-niu-sai-gon', NULL, NULL, NULL, NULL),
	('9aaaab37-8402-4d12-b84e-11a0bc2cb7d3', 'COM-TAM-AN-GIANG', NULL, NULL, NULL, NULL, NULL, '/data/product/product-22.png', '9aaaab37-80c0-4c27-b7bb-cdd7e3f30346', '9aaaab37-7f88-40f5-ba7a-670856402143', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'com-tam-an-giang', NULL, NULL, NULL, NULL),
	('9aaaab37-8406-4633-8a38-964a4ac08e9e', 'VAI-THIEU-LUC-NGAN', NULL, NULL, NULL, NULL, NULL, '/data/product/product-23.png', '9aaaab37-80ab-4b54-abf9-7f6ecdb06410', '9aaaab37-7f88-40f5-ba7a-670856402143', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'vai-thieu-luc-ngan', NULL, NULL, NULL, NULL),
	('9aaaab37-840a-4365-adac-ead00f1f42a5', 'NEM-CHUA-THANH-HOA', NULL, NULL, NULL, NULL, NULL, '/data/product/product-24.png', '9aaaab37-80a3-4180-a64d-c1367cd8c097', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'nem-chua-thanh-hoa', NULL, NULL, NULL, NULL),
	('9aaaab37-840e-44af-87f3-f1b19fe3d35a', 'CHA-CA-NHA-TRANG', NULL, NULL, NULL, NULL, NULL, '/data/product/product-25.png', '9aaaab37-809e-4184-bd21-2fa9d013d1f8', '9aaaab37-7f88-40f5-ba7a-670856402143', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'cha-ca-nha-trang', NULL, NULL, NULL, NULL),
	('9aaaab37-8412-4df6-95dd-e87fd4212339', 'HO-TIEU', NULL, NULL, NULL, NULL, NULL, '/data/product/product-26.png', '9aaaab37-80a3-4180-a64d-c1367cd8c097', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'ho-tieu', NULL, NULL, NULL, NULL),
	('9aaaab37-8415-41c1-b1dd-1864ccf103df', 'NHAN-LONG-HUNG-YEN', NULL, NULL, NULL, NULL, NULL, '/data/product/product-27.png', '9aaaab37-80ab-4b54-abf9-7f6ecdb06410', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'nhan-long-hung-yen', NULL, NULL, NULL, NULL),
	('9aaaab37-841b-4915-a70e-357ed2e8afc2', 'CA-PHE-BUON-ME', NULL, NULL, NULL, NULL, NULL, '/data/product/product-28.png', '9aaaab37-80cf-4962-b4dd-41473a4ddd89', '9aaaab37-7f88-40f5-ba7a-670856402143', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'ca-phe-buon-me', NULL, NULL, NULL, NULL),
	('9aaaab37-841e-41f5-ba0d-11e3306d79ef', 'KEO-DUA-BEN-TRE', NULL, NULL, NULL, NULL, NULL, '/data/product/product-29.png', '9aaaab37-80da-4b6e-a10a-21b82114c40a', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'keo-dua-ben-tre', NULL, NULL, NULL, NULL),
	('9aaaab37-8422-4676-9140-c69a3fc1eebc', 'MANG-CUT', NULL, NULL, NULL, NULL, NULL, '/data/product/product-30.png', '9aaaab37-80a3-4180-a64d-c1367cd8c097', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'mang-cut', NULL, NULL, NULL, NULL),
	('9aaaab37-8426-4bdd-b681-a0558d60e1fd', 'NON-LA-VIETNAM', NULL, NULL, NULL, NULL, NULL, '/data/product/product-31.png', '9aaaab37-8097-449b-8e70-e1a3c09cdacc', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'non-la-vietnam', NULL, NULL, NULL, NULL),
	('9aaaab37-842a-4e12-a6d5-33a7c1996b44', 'THIT-TRAU-GAC-BEP', NULL, NULL, NULL, NULL, NULL, '/data/product/product-32.png', '9aaaab37-8097-449b-8e70-e1a3c09cdacc', '9aaaab37-7f88-40f5-ba7a-670856402143', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'thit-trau-gac-bep', NULL, NULL, NULL, NULL),
	('9aaaab37-842e-48f0-ad0a-b1358ec13598', 'PHO-HA-NOI', NULL, NULL, NULL, NULL, NULL, '/data/product/product-33.png', '9aaaab37-809e-4184-bd21-2fa9d013d1f8', '9aaaab37-7f88-40f5-ba7a-670856402143', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 1, 'physical', 'auto', 1, 1, 0, 0, 'pho-ha-noi', NULL, NULL, NULL, NULL),
	('9aaaab37-8431-49b6-84b8-d810c80c2c4f', 'BANH-MY-CHA-CA', NULL, NULL, NULL, NULL, NULL, '/data/product/product-34.png', '9aaaab37-80cf-4962-b4dd-41473a4ddd89', '9aaaab37-7f88-40f5-ba7a-670856402143', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 2, 'physical', 'auto', 1, 1, 0, 0, 'banh-my-cha-ca', NULL, NULL, NULL, NULL),
	('9aaaab37-8436-49c8-9c85-9cab300f6d7f', 'AO-DAI-VIETNAM', NULL, NULL, NULL, NULL, NULL, '/data/product/product-35.png', '9aaaab37-8088-4ecd-a363-50210705b610', '9aaaab37-7f88-40f5-ba7a-670856402143', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'ao-dai-vietnam', NULL, NULL, NULL, NULL),
	('9aaaab37-843a-4235-86b5-bda759cfe75c', 'THANH-LONG-RUOT-DO', NULL, NULL, NULL, NULL, NULL, '/data/product/product-36.png', '9aaaab37-80c0-4c27-b7bb-cdd7e3f30346', '9aaaab37-7f80-43df-a8ad-abc48a388d95', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'thanh-long-ruot-do', NULL, NULL, NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_product` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_product_attribute
CREATE TABLE IF NOT EXISTS `gc_shop_product_attribute` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `status` tinyint NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `gc_shop_product_attribute_product_id_attribute_group_id_index` (`product_id`,`attribute_group_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_product_attribute: ~8 rows (approximately)
DELETE FROM `gc_shop_product_attribute`;
/*!40000 ALTER TABLE `gc_shop_product_attribute` DISABLE KEYS */;
INSERT INTO `gc_shop_product_attribute` (`id`, `name`, `attribute_group_id`, `product_id`, `add_price`, `sort`, `status`) VALUES
	(1, 'Blue', 1, '9aaaab37-843a-4235-86b5-bda759cfe75c', 5.00, 0, 1),
	(2, 'White', 1, '9aaaab37-843a-4235-86b5-bda759cfe75c', 0.00, 0, 1),
	(3, 'S', 2, '9aaaab37-843a-4235-86b5-bda759cfe75c', 2.00, 0, 1),
	(4, 'XL', 2, '9aaaab37-843a-4235-86b5-bda759cfe75c', 3.00, 0, 1),
	(5, 'Blue', 1, '9aaaab37-83db-4e08-861c-c33966fa737e', 10.00, 0, 1),
	(6, 'Red', 1, '9aaaab37-83db-4e08-861c-c33966fa737e', 0.00, 0, 1),
	(7, 'S', 2, '9aaaab37-83db-4e08-861c-c33966fa737e', 0.00, 0, 1),
	(8, 'M', 2, '9aaaab37-83db-4e08-861c-c33966fa737e', 0.00, 0, 1);
/*!40000 ALTER TABLE `gc_shop_product_attribute` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_product_build
CREATE TABLE IF NOT EXISTS `gc_shop_product_build` (
...
-- Dumping data for table grakan.gc_shop_product_build: ~8 rows (approximately)
DELETE FROM `gc_shop_product_build`;
/*!40000 ALTER TABLE `gc_shop_product_build` DISABLE KEYS */;
INSERT INTO `gc_shop_product_build` (`build_id`, `product_id`, `quantity`) VALUES
	('9aaaab37-83bb-4097-afa8-fa30af7ad7bd', '9aaaab37-83b1-400e-914f-4cb6596eff24', 1),
	('9aaaab37-83bb-4097-afa8-fa30af7ad7bd', '9aaaab37-83c4-4c31-8926-586609cd35d5', 2),
	('9aaaab37-83d2-406f-b63a-9146597d78ed', '9aaaab37-83df-4fa0-abb7-d28eceebf77a', 1),
	('9aaaab37-83d2-406f-b63a-9146597d78ed', '9aaaab37-83ef-4e35-bfea-da6c62b21b91', 2),
	('9aaaab37-83e7-4deb-be5d-5493eb2486d9', '9aaaab37-83e3-4876-8631-1366126a9e47', 2),
	('9aaaab37-83e7-4deb-be5d-5493eb2486d9', '9aaaab37-83eb-4670-9801-662c667f7e83', 1),
	('9aaaab37-842e-48f0-ad0a-b1358ec13598', '9aaaab37-83b1-400e-914f-4cb6596eff24', 2),
	('9aaaab37-842e-48f0-ad0a-b1358ec13598', '9aaaab37-83df-4fa0-abb7-d28eceebf77a', 2);
/*!40000 ALTER TABLE `gc_shop_product_build` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_product_category
CREATE TABLE IF NOT EXISTS `gc_shop_product_category` (
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`product_id`,`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_product_category: ~38 rows (approximately)
DELETE FROM `gc_shop_product_category`;
/*!40000 ALTER TABLE `gc_shop_product_category` DISABLE KEYS */;
INSERT INTO `gc_shop_product_category` (`product_id`, `category_id`) VALUES
	('9aaaab37-83a3-42c2-8a12-ae5c2ea15fe7', '9aaaab37-7b31-4c24-a2e6-dbfcd2055e99'),
	('9aaaab37-83a3-42c2-8a12-ae5c2ea15fe7', '9aaaab37-7b48-40c2-8f76-cc02ecdfab7f'),
	('9aaaab37-83a3-42c2-8a12-ae5c2ea15fe7', '9aaaab37-7b5c-4166-9d21-63e6a4698be9'),
	('9aaaab37-83ac-4861-ac51-353b5c74c21f', '9aaaab37-7b5c-4166-9d21-63e6a4698be9'),
	('9aaaab37-83b1-400e-914f-4cb6596eff24', '9aaaab37-7b4e-4c96-86bc-ab82947f6fc3'),
	('9aaaab37-83b6-41ec-b33c-d16a1cf620d3', '9aaaab37-7b79-4513-9afb-27bda061aedc'),
	('9aaaab37-83bb-4097-afa8-fa30af7ad7bd', '9aaaab37-7b4e-4c96-86bc-ab82947f6fc3'),
	('9aaaab37-83c0-4ed3-80cb-35f54a4af90e', '9aaaab37-7b4e-4c96-86bc-ab82947f6fc3'),
	('9aaaab37-83c4-4c31-8926-586609cd35d5', '9aaaab37-7b56-471c-8777-5fb101429687'),
	('9aaaab37-83c9-46a1-998a-d29b021a83f3', '9aaaab37-7b48-40c2-8f76-cc02ecdfab7f'),
	('9aaaab37-83cd-4024-a5cd-4de10ce3f8bb', '9aaaab37-7b31-4c24-a2e6-dbfcd2055e99'),
	('9aaaab37-83d2-406f-b63a-9146597d78ed', '9aaaab37-7b4e-4c96-86bc-ab82947f6fc3'),
	('9aaaab37-83d6-491b-828d-b351b171a3e7', '9aaaab37-7b48-40c2-8f76-cc02ecdfab7f'),
	('9aaaab37-83db-4e08-861c-c33966fa737e', '9aaaab37-7b3f-4360-af44-31a15e369d77'),
	('9aaaab37-83df-4fa0-abb7-d28eceebf77a', '9aaaab37-7b2d-4368-b2ff-3e0c7078e9e3'),
	('9aaaab37-83e3-4876-8631-1366126a9e47', '9aaaab37-7b4e-4c96-86bc-ab82947f6fc3'),
	('9aaaab37-83e7-4deb-be5d-5493eb2486d9', '9aaaab37-7b31-4c24-a2e6-dbfcd2055e99'),
	('9aaaab37-83eb-4670-9801-662c667f7e83', '9aaaab37-7b2d-4368-b2ff-3e0c7078e9e3'),
	('9aaaab37-83ef-4e35-bfea-da6c62b21b91', '9aaaab37-7b3f-4360-af44-31a15e369d77'),
	('9aaaab37-83f2-4d39-9d4e-4fc3dab567d5', '9aaaab37-7b84-4a9d-ace8-1c045829bbd9'),
	('9aaaab37-83f6-4734-8e51-71f1b33d7e8b', '9aaaab37-7b31-4c24-a2e6-dbfcd2055e99'),
	('9aaaab37-83fa-48b5-8c38-6d9f9e9b9338', '9aaaab37-7b4e-4c96-86bc-ab82947f6fc3'),
	('9aaaab37-83ff-4d72-a583-f815af568d12', '9aaaab37-7b48-40c2-8f76-cc02ecdfab7f'),
	('9aaaab37-8402-4d12-b84e-11a0bc2cb7d3', '9aaaab37-7b8e-4375-963d-d41ffb1998ab'),
	('9aaaab37-8406-4633-8a38-964a4ac08e9e', '9aaaab37-7b56-471c-8777-5fb101429687'),
	('9aaaab37-840a-4365-adac-ead00f1f42a5', '9aaaab37-7b3f-4360-af44-31a15e369d77'),
	('9aaaab37-840e-44af-87f3-f1b19fe3d35a', '9aaaab37-7bcb-4b9e-943d-412cd30d2528'),
	('9aaaab37-8412-4df6-95dd-e87fd4212339', '9aaaab37-7b73-4e7b-b060-b0df0fee39fd'),
	('9aaaab37-8415-41c1-b1dd-1864ccf103df', '9aaaab37-7b6c-445f-99b9-ade62188c7fb'),
	('9aaaab37-841b-4915-a70e-357ed2e8afc2', '9aaaab37-7b6c-445f-99b9-ade62188c7fb'),
	('9aaaab37-841e-41f5-ba0d-11e3306d79ef', '9aaaab37-7b5c-4166-9d21-63e6a4698be9'),
	('9aaaab37-8422-4676-9140-c69a3fc1eebc', '9aaaab37-7b73-4e7b-b060-b0df0fee39fd'),
	('9aaaab37-8426-4bdd-b681-a0558d60e1fd', '9aaaab37-7b4e-4c96-86bc-ab82947f6fc3'),
	('9aaaab37-842a-4e12-a6d5-33a7c1996b44', '9aaaab37-7b73-4e7b-b060-b0df0fee39fd'),
	('9aaaab37-842e-48f0-ad0a-b1358ec13598', '9aaaab37-7b89-4fb8-af4f-9cbcda2eba80'),
	('9aaaab37-8431-49b6-84b8-d810c80c2c4f', '9aaaab37-7b84-4a9d-ace8-1c045829bbd9'),
	('9aaaab37-8436-49c8-9c85-9cab300f6d7f', '9aaaab37-7b73-4e7b-b060-b0df0fee39fd'),
	('9aaaab37-843a-4235-86b5-bda759cfe75c', '9aaaab37-7b73-4e7b-b060-b0df0fee39fd');
/*!40000 ALTER TABLE `gc_shop_product_category` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_product_description
CREATE TABLE IF NOT EXISTS `gc_shop_product_description` (
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lang` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content` mediumtext COLLATE utf8mb4_unicode_ci,
  UNIQUE KEY `gc_shop_product_description_product_id_lang_unique` (`product_id`,`lang`),
  KEY `gc_shop_product_description_lang_index` (`lang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_product_description: ~72 rows (approximately)
DELETE FROM `gc_shop_product_description`;
/*!40000 ALTER TABLE `gc_shop_product_description` DISABLE KEYS */;
INSERT INTO `gc_shop_product_description` (`product_id`, `lang`, `name`, `keyword`, `description`, `content`) VALUES
	('9aaaab37-83a3-42c2-8a12-ae5c2ea15fe7', 'en', 'Cu Do Ha Tinh', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83a3-42c2-8a12-ae5c2ea15fe7', 'vi', 'Cu Do Ha Tinh', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83ac-4861-ac51-353b5c74c21f', 'en', 'Man Hau Lang Son', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83ac-4861-ac51-353b5c74c21f', 'vi', 'Man Hau Lang Son', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83b1-400e-914f-4cb6596eff24', 'en', 'Banh Gai Tu Tru', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83b1-400e-914f-4cb6596eff24', 'vi', 'Banh Gai Tu Tru', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83b6-41ec-b33c-d16a1cf620d3', 'en', 'Bun Bo Hue', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83b6-41ec-b33c-d16a1cf620d3', 'vi', 'Bun Bo Hue', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83bb-4097-afa8-fa30af7ad7bd', 'en', 'Banh Trang Tron', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83bb-4097-afa8-fa30af7ad7bd', 'vi', 'Banh Trang Tron', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83c0-4ed3-80cb-35f54a4af90e', 'en', 'Muoi Tay Ninh', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83c0-4ed3-80cb-35f54a4af90e', 'vi', 'Muoi Tay Ninh', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83c4-4c31-8926-586609cd35d5', 'en', 'Keo Doi Lac', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83c4-4c31-8926-586609cd35d5', 'vi', 'Keo Doi Lac', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83c9-46a1-998a-d29b021a83f3', 'en', 'Sau Rieng Dak Lak', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83c9-46a1-998a-d29b021a83f3', 'vi', 'Sau Rieng Dak Lak', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83cd-4024-a5cd-4de10ce3f8bb', 'en', 'Don Quang Ngai', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83cd-4024-a5cd-4de10ce3f8bb', 'vi', 'Don Quang Ngai', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83d2-406f-b63a-9146597d78ed', 'en', 'Banh Khot Vung Tau', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83d2-406f-b63a-9146597d78ed', 'vi', 'Banh Khot Vung Tau', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83d6-491b-828d-b351b171a3e7', 'en', 'Chao Luon Xu Nghe', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83d6-491b-828d-b351b171a3e7', 'vi', 'Chao Luon Xu Nghe', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83db-4e08-861c-c33966fa737e', 'en', 'Banh Dau Xanh Hung Yen', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83db-4e08-861c-c33966fa737e', 'vi', 'Banh Dau Xanh Hung Yen', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83df-4fa0-abb7-d28eceebf77a', 'en', 'Hu Tieu Nam Vang', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83df-4fa0-abb7-d28eceebf77a', 'vi', 'Hu Tieu Nam Vang', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83e3-4876-8631-1366126a9e47', 'en', 'Canh Chua Ca Loc', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83e3-4876-8631-1366126a9e47', 'vi', 'Canh Chua Ca Loc', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83e7-4deb-be5d-5493eb2486d9', 'en', 'Chom Chom Nhan', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83e7-4deb-be5d-5493eb2486d9', 'vi', 'Chom Chom Nhan', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83eb-4670-9801-662c667f7e83', 'en', 'Cam Vinh Loai I', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83eb-4670-9801-662c667f7e83', 'vi', 'Cam Vinh Loai I', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83ef-4e35-bfea-da6c62b21b91', 'en', 'Mi Quang', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83ef-4e35-bfea-da6c62b21b91', 'vi', 'Mi Quang', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83f2-4d39-9d4e-4fc3dab567d5', 'en', 'Chao Long Tiet Canh', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83f2-4d39-9d4e-4fc3dab567d5', 'vi', 'Chao Long Tiet Canh', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83f6-4734-8e51-71f1b33d7e8b', 'en', 'Cam Sanh Mong Nuoc', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83f6-4734-8e51-71f1b33d7e8b', 'vi', 'Cam Sanh Mong Nuoc', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83fa-48b5-8c38-6d9f9e9b9338', 'en', 'Xoai Cat Hoa Loc', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83fa-48b5-8c38-6d9f9e9b9338', 'vi', 'Xoai Cat Hoa Loc', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83ff-4d72-a583-f815af568d12', 'en', 'Com Niu Sai Gon', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-83ff-4d72-a583-f815af568d12', 'vi', 'Com Niu Sai Gon', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8402-4d12-b84e-11a0bc2cb7d3', 'en', 'Com Tam An Giang', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8402-4d12-b84e-11a0bc2cb7d3', 'vi', 'Com Tam An Giang', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8406-4633-8a38-964a4ac08e9e', 'en', 'Vai Thieu Luc Ngan', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8406-4633-8a38-964a4ac08e9e', 'vi', 'Vai Thieu Luc Ngan', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-840a-4365-adac-ead00f1f42a5', 'en', 'Nem Chua Thanh Hoa', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-840a-4365-adac-ead00f1f42a5', 'vi', 'Nem Chua Thanh Hoa', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-840e-44af-87f3-f1b19fe3d35a', 'en', 'Cha Ca Nha Trang', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-840e-44af-87f3-f1b19fe3d35a', 'vi', 'Cha Ca Nha Trang', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8412-4df6-95dd-e87fd4212339', 'en', 'Ho Tieu', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8412-4df6-95dd-e87fd4212339', 'vi', 'Ho Tieu', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8415-41c1-b1dd-1864ccf103df', 'en', 'Nhan Long Hung Yen', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8415-41c1-b1dd-1864ccf103df', 'vi', 'Nhan Long Hung Yen', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-841b-4915-a70e-357ed2e8afc2', 'en', 'Ca Phe Buon Me', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-841b-4915-a70e-357ed2e8afc2', 'vi', 'Ca Phe Buon Me', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-841e-41f5-ba0d-11e3306d79ef', 'en', 'Keo Dua Ben Tre', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-841e-41f5-ba0d-11e3306d79ef', 'vi', 'Keo Dua Ben Tre', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8422-4676-9140-c69a3fc1eebc', 'en', 'Mang Cut', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8422-4676-9140-c69a3fc1eebc', 'vi', 'Mang Cut', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8426-4bdd-b681-a0558d60e1fd', 'en', 'Non La Vietnam', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8426-4bdd-b681-a0558d60e1fd', 'vi', 'Non La Vietnam', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-842a-4e12-a6d5-33a7c1996b44', 'en', 'Thit Trau Gac Bep', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-842a-4e12-a6d5-33a7c1996b44', 'vi', 'Thit Trau Gac Bep', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-842e-48f0-ad0a-b1358ec13598', 'en', 'Pho Ha Noi', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-842e-48f0-ad0a-b1358ec13598', 'vi', 'Pho Ha Noi', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8431-49b6-84b8-d810c80c2c4f', 'en', 'Banh My Cha Ca', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8431-49b6-84b8-d810c80c2c4f', 'vi', 'Banh My Cha Ca', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8436-49c8-9c85-9cab300f6d7f', 'en', 'Ao Dai Vietnam', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-8436-49c8-9c85-9cab300f6d7f', 'vi', 'Ao Dai Vietnam', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-843a-4235-86b5-bda759cfe75c', 'en', 'Thanh Long Ruot Do', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9aaaab37-843a-4235-86b5-bda759cfe75c', 'vi', 'Thanh Long Ruot Do', NULL, '- 27-inch (diagonal) Retina 5K display\r\n        - 3.1GHz 6-core 10th-generation Intel Core i5\r\n        - AMD Radeon Pro 5300 graphics', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>');
/*!40000 ALTER TABLE `gc_shop_product_description` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_product_download
CREATE TABLE IF NOT EXISTS `gc_shop_product_download` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `path` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping data for table grakan.gc_shop_product_download: ~0 rows (approximately)
DELETE FROM `gc_shop_product_download`;
/*!40000 ALTER TABLE `gc_shop_product_download` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_shop_product_download` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_product_group
CREATE TABLE IF NOT EXISTS `gc_shop_product_group` (
  `group_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`group_id`,`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_product_group: ~8 rows (approximately)
DELETE FROM `gc_shop_product_group`;
/*!40000 ALTER TABLE `gc_shop_product_group` DISABLE KEYS */;
INSERT INTO `gc_shop_product_group` (`group_id`, `product_id`) VALUES
	('9aaaab37-83b6-41ec-b33c-d16a1cf620d3', '9aaaab37-83ac-4861-ac51-353b5c74c21f'),
	('9aaaab37-83b6-41ec-b33c-d16a1cf620d3', '9aaaab37-83c0-4ed3-80cb-35f54a4af90e'),
	('9aaaab37-83e3-4876-8631-1366126a9e47', '9aaaab37-83ac-4861-ac51-353b5c74c21f'),
	('9aaaab37-83e3-4876-8631-1366126a9e47', '9aaaab37-83db-4e08-861c-c33966fa737e'),
	('9aaaab37-83f6-4734-8e51-71f1b33d7e8b', '9aaaab37-83d6-491b-828d-b351b171a3e7'),
	('9aaaab37-83f6-4734-8e51-71f1b33d7e8b', '9aaaab37-83ff-4d72-a583-f815af568d12'),
	('9aaaab37-8431-49b6-84b8-d810c80c2c4f', '9aaaab37-83b1-400e-914f-4cb6596eff24'),
	('9aaaab37-8431-49b6-84b8-d810c80c2c4f', '9aaaab37-83c4-4c31-8926-586609cd35d5');
/*!40000 ALTER TABLE `gc_shop_product_group` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_product_image
CREATE TABLE IF NOT EXISTS `gc_shop_product_image` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `gc_shop_product_image_product_id_index` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_product_image: ~24 rows (approximately)
DELETE FROM `gc_shop_product_image`;
/*!40000 ALTER TABLE `gc_shop_product_image` DISABLE KEYS */;
INSERT INTO `gc_shop_product_image` (`id`, `image`, `product_id`) VALUES
	('9aaaab37-843e-4fdb-9c0c-f31511fc0985', '/data/product/product-2.png', '9aaaab37-83a3-42c2-8a12-ae5c2ea15fe7'),
	('9aaaab37-8442-4897-b90d-2b6e92225e65', '/data/product/product-11.png', '9aaaab37-83a3-42c2-8a12-ae5c2ea15fe7'),
	('9aaaab37-8446-49b8-a634-1c2450bdef0f', '/data/product/product-8.png', '9aaaab37-83d6-491b-828d-b351b171a3e7'),
	('9aaaab37-844a-413e-872f-c222805ab597', '/data/product/product-6.png', '9aaaab37-83ac-4861-ac51-353b5c74c21f'),
	('9aaaab37-844d-4ea6-88ec-e2ce7bdc8707', '/data/product/product-13.png', '9aaaab37-83d6-491b-828d-b351b171a3e7'),
	('9aaaab37-8451-4a88-a1d5-3146c0be48d6', '/data/product/product-12.png', '9aaaab37-83bb-4097-afa8-fa30af7ad7bd'),
	('9aaaab37-8456-40a1-a974-cb493a9acba2', '/data/product/product-17.png', '9aaaab37-83bb-4097-afa8-fa30af7ad7bd'),
	('9aaaab37-845a-4e8b-9d1a-82b2ab51596b', '/data/product/product-11.png', '9aaaab37-83ac-4861-ac51-353b5c74c21f'),
	('9aaaab37-845d-4620-b1c9-4ca6f6896409', '/data/product/product-5.png', '9aaaab37-83ac-4861-ac51-353b5c74c21f'),
	('9aaaab37-8462-43df-a3b6-b5ec4b713874', '/data/product/product-12.png', '9aaaab37-83cd-4024-a5cd-4de10ce3f8bb'),
	('9aaaab37-8465-45e3-a871-86ef85cbfff7', '/data/product/product-15.png', '9aaaab37-83c9-46a1-998a-d29b021a83f3'),
	('9aaaab37-8469-4779-9850-807bc3dfd374', '/data/product/product-19.png', '9aaaab37-83c4-4c31-8926-586609cd35d5'),
	('9aaaab37-846d-4a7c-84a9-69e00a5b8c9a', '/data/product/product-12.png', '9aaaab37-83c4-4c31-8926-586609cd35d5'),
	('9aaaab37-8471-46e5-932b-9d1c16edc8b5', '/data/product/product-1.png', '9aaaab37-83bb-4097-afa8-fa30af7ad7bd'),
	('9aaaab37-8475-46ff-9ac1-04ecf36800cf', '/data/product/product-12.png', '9aaaab37-83b6-41ec-b33c-d16a1cf620d3'),
	('9aaaab37-8479-45bc-aa8b-e644d5053024', '/data/product/product-7.png', '9aaaab37-83e7-4deb-be5d-5493eb2486d9'),
	('9aaaab37-847d-4639-82dd-c74ba2d03fac', '/data/product/product-12.png', '9aaaab37-83e7-4deb-be5d-5493eb2486d9'),
	('9aaaab37-8481-44b1-8162-64cdf124d8c6', '/data/product/product-16.png', '9aaaab37-83ef-4e35-bfea-da6c62b21b91'),
	('9aaaab37-8484-48ed-87d9-43a2ab686e66', '/data/product/product-6.png', '9aaaab37-83ef-4e35-bfea-da6c62b21b91'),
	('9aaaab37-8488-4f0c-a8cd-94b8517ea7cb', '/data/product/product-12.png', '9aaaab37-83ef-4e35-bfea-da6c62b21b91'),
	('9aaaab37-848c-4000-a620-28fe0bfa5916', '/data/product/product-18.png', '9aaaab37-8402-4d12-b84e-11a0bc2cb7d3'),
	('9aaaab37-8490-4122-b728-c777ef63ce0a', '/data/product/product-19.png', '9aaaab37-8402-4d12-b84e-11a0bc2cb7d3'),
	('9aaaab37-8494-47d1-9078-0010d17e9911', '/data/product/product-24.png', '9aaaab37-840a-4365-adac-ead00f1f42a5'),
	('9aaaab37-8498-47ac-980c-8bed4d7428c1', '/data/product/product-22.png', '9aaaab37-840a-4365-adac-ead00f1f42a5');
/*!40000 ALTER TABLE `gc_shop_product_image` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_product_promotion
CREATE TABLE IF NOT EXISTS `gc_shop_product_promotion` (
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `price_promotion` decimal(15,2) NOT NULL,
  `date_start` timestamp NULL DEFAULT NULL,
  `date_end` timestamp NULL DEFAULT NULL,
  `status_promotion` int NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_product_promotion: ~14 rows (approximately)
DELETE FROM `gc_shop_product_promotion`;
/*!40000 ALTER TABLE `gc_shop_product_promotion` DISABLE KEYS */;
INSERT INTO `gc_shop_product_promotion` (`product_id`, `price_promotion`, `date_start`, `date_end`, `status_promotion`, `created_at`, `updated_at`) VALUES
	('9aaaab37-83a3-42c2-8a12-ae5c2ea15fe7', 50.00, NULL, NULL, 1, NULL, NULL),
	('9aaaab37-83ac-4861-ac51-353b5c74c21f', 30.00, NULL, NULL, 1, NULL, NULL),
	('9aaaab37-83c0-4ed3-80cb-35f54a4af90e', 50.00, NULL, NULL, 1, NULL, NULL),
	('9aaaab37-83c9-46a1-998a-d29b021a83f3', 40.00, NULL, NULL, 1, NULL, NULL),
	('9aaaab37-83db-4e08-861c-c33966fa737e', 50.00, NULL, NULL, 1, NULL, NULL),
	('9aaaab37-83eb-4670-9801-662c667f7e83', 30.00, NULL, NULL, 1, NULL, NULL),
	('9aaaab37-83f2-4d39-9d4e-4fc3dab567d5', 60.00, NULL, NULL, 1, NULL, NULL),
	('9aaaab37-8402-4d12-b84e-11a0bc2cb7d3', 50.00, NULL, NULL, 1, NULL, NULL),
	('9aaaab37-8412-4df6-95dd-e87fd4212339', 60.00, NULL, NULL, 1, NULL, NULL),
	('9aaaab37-841b-4915-a70e-357ed2e8afc2', 50.00, NULL, NULL, 1, NULL, NULL),
	('9aaaab37-8422-4676-9140-c69a3fc1eebc', 60.00, NULL, NULL, 1, NULL, NULL),
	('9aaaab37-8426-4bdd-b681-a0558d60e1fd', 50.00, NULL, NULL, 1, NULL, NULL),
	('9aaaab37-8436-49c8-9c85-9cab300f6d7f', 60.00, NULL, NULL, 1, NULL, NULL),
	('9aaaab37-843a-4235-86b5-bda759cfe75c', 50.00, NULL, NULL, 1, NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_product_promotion` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_product_property
CREATE TABLE IF NOT EXISTS `gc_shop_product_property` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_shop_product_property_code_unique` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_product_property: ~2 rows (approximately)
DELETE FROM `gc_shop_product_property`;
/*!40000 ALTER TABLE `gc_shop_product_property` DISABLE KEYS */;
INSERT INTO `gc_shop_product_property` (`id`, `code`, `name`, `created_at`, `updated_at`) VALUES
	(1, 'physical', 'Product physical', NULL, NULL),
	(2, 'download', 'Product download', NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_product_property` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_product_store
CREATE TABLE IF NOT EXISTS `gc_shop_product_store` (
  `product_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_product_store: ~36 rows (approximately)
DELETE FROM `gc_shop_product_store`;
/*!40000 ALTER TABLE `gc_shop_product_store` DISABLE KEYS */;
INSERT INTO `gc_shop_product_store` (`product_id`, `store_id`) VALUES
	('9aaaab37-83a3-42c2-8a12-ae5c2ea15fe7', '1'),
	('9aaaab37-83ac-4861-ac51-353b5c74c21f', '1'),
	('9aaaab37-83b1-400e-914f-4cb6596eff24', '1'),
	('9aaaab37-83b6-41ec-b33c-d16a1cf620d3', '1'),
	('9aaaab37-83bb-4097-afa8-fa30af7ad7bd', '1'),
	('9aaaab37-83c0-4ed3-80cb-35f54a4af90e', '1'),
	('9aaaab37-83c4-4c31-8926-586609cd35d5', '1'),
	('9aaaab37-83c9-46a1-998a-d29b021a83f3', '1'),
	('9aaaab37-83cd-4024-a5cd-4de10ce3f8bb', '1'),
	('9aaaab37-83d2-406f-b63a-9146597d78ed', '1'),
	('9aaaab37-83d6-491b-828d-b351b171a3e7', '1'),
	('9aaaab37-83db-4e08-861c-c33966fa737e', '1'),
	('9aaaab37-83df-4fa0-abb7-d28eceebf77a', '1'),
	('9aaaab37-83e3-4876-8631-1366126a9e47', '1'),
	('9aaaab37-83e7-4deb-be5d-5493eb2486d9', '1'),
	('9aaaab37-83eb-4670-9801-662c667f7e83', '1'),
	('9aaaab37-83ef-4e35-bfea-da6c62b21b91', '1'),
	('9aaaab37-83f2-4d39-9d4e-4fc3dab567d5', '1'),
	('9aaaab37-83f6-4734-8e51-71f1b33d7e8b', '1'),
	('9aaaab37-83fa-48b5-8c38-6d9f9e9b9338', '1'),
	('9aaaab37-83ff-4d72-a583-f815af568d12', '1'),
	('9aaaab37-8402-4d12-b84e-11a0bc2cb7d3', '1'),
	('9aaaab37-8406-4633-8a38-964a4ac08e9e', '1'),
	('9aaaab37-840a-4365-adac-ead00f1f42a5', '1'),
	('9aaaab37-840e-44af-87f3-f1b19fe3d35a', '1'),
	('9aaaab37-8412-4df6-95dd-e87fd4212339', '1'),
	('9aaaab37-8415-41c1-b1dd-1864ccf103df', '1'),
	('9aaaab37-841b-4915-a70e-357ed2e8afc2', '1'),
	('9aaaab37-841e-41f5-ba0d-11e3306d79ef', '1'),
	('9aaaab37-8422-4676-9140-c69a3fc1eebc', '1'),
	('9aaaab37-8426-4bdd-b681-a0558d60e1fd', '1'),
	('9aaaab37-842a-4e12-a6d5-33a7c1996b44', '1'),
	('9aaaab37-842e-48f0-ad0a-b1358ec13598', '1'),
	('9aaaab37-8431-49b6-84b8-d810c80c2c4f', '1'),
	('9aaaab37-8436-49c8-9c85-9cab300f6d7f', '1'),
	('9aaaab37-843a-4235-86b5-bda759cfe75c', '1');
/*!40000 ALTER TABLE `gc_shop_product_store` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_sessions
CREATE TABLE IF NOT EXISTS `gc_shop_sessions` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  UNIQUE KEY `gc_shop_sessions_id_unique` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_sessions: ~0 rows (approximately)
DELETE FROM `gc_shop_sessions`;
/*!40000 ALTER TABLE `gc_shop_sessions` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_shop_sessions` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_shipping_standard
CREATE TABLE IF NOT EXISTS `gc_shop_shipping_standard` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table grakan.gc_shop_shipping_standard: ~1 rows (approximately)
DELETE FROM `gc_shop_shipping_standard`;
/*!40000 ALTER TABLE `gc_shop_shipping_standard` DISABLE KEYS */;
INSERT INTO `gc_shop_shipping_standard` (`id`, `fee`, `shipping_free`, `created_at`, `updated_at`) VALUES
	(1, 20.00, 10000.00, NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_shipping_standard` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_shipping_status
CREATE TABLE IF NOT EXISTS `gc_shop_shipping_status` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
-- Dumping data for table grakan.gc_shop_shipping_status: ~3 rows (approximately)
DELETE FROM `gc_shop_shipping_status`;
/*!40000 ALTER TABLE `gc_shop_shipping_status` DISABLE KEYS */;
INSERT INTO `gc_shop_shipping_status` (`id`, `name`, `created_at`, `updated_at`) VALUES
	(1, 'Not sent', NULL, NULL),
	(2, 'Sending', NULL, NULL),
	(3, 'Shipping done', NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_shipping_status` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_shoppingcart
CREATE TABLE IF NOT EXISTS `gc_shop_shoppingcart` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  KEY `gc_shop_shoppingcart_identifier_instance_index` (`identifier`,`instance`),
  KEY `gc_shop_shoppingcart_store_id_index` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_shoppingcart: ~0 rows (approximately)
DELETE FROM `gc_shop_shoppingcart`;
/*!40000 ALTER TABLE `gc_shop_shoppingcart` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_shop_shoppingcart` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_store_block
CREATE TABLE IF NOT EXISTS `gc_shop_store_block` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `position` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_store_block_store_id_index` (`store_id`),
  KEY `gc_shop_store_block_template_index` (`template`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_store_block: ~8 rows (approximately)
DELETE FROM `gc_shop_store_block`;
/*!40000 ALTER TABLE `gc_shop_store_block` DISABLE KEYS */;
INSERT INTO `gc_shop_store_block` (`id`, `name`, `position`, `page`, `type`, `text`, `status`, `sort`, `store_id`, `template`, `created_at`, `updated_at`) VALUES
	('9aaaab35-9c95-4efe-996d-82ffe054fc88', 'Banner top (grakan-light)', 'banner_top', 'home', 'view', 'banner_image', 1, 10, '1', 'grakan-light', NULL, NULL),
	('9aaaab35-9cb2-470a-8b97-74abe2dd5af4', 'New product (grakan-light)', 'top', 'home', 'view', 'product_new', 1, 20, '1', 'grakan-light', NULL, NULL),
	('9aaaab35-9ccb-4b73-b6fb-aaab1ea021bc', 'Top news (grakan-light)', 'bottom', 'home', 'view', 'top_news', 1, 10, '1', 'grakan-light', NULL, NULL),
	('9aaaab35-9cde-4aaf-ade1-01c6c59665b3', 'Category store left (grakan-light)', 'left', 'shop_home,vendor_home,vendor_product_list', 'view', 'category_store_left', 1, 10, '1', 'grakan-light', NULL, NULL),
	('9aaaab35-9cf1-42cc-806b-a9e557eb8de0', 'Category left (grakan-light)', 'left', 'shop_product_list,shop_home', 'view', 'category_left', 1, 20, '1', 'grakan-light', NULL, NULL),
	('9aaaab35-9d04-4264-9079-8b716d8f6a05', 'Brand left (grakan-light)', 'left', 'shop_product_list,shop_home', 'view', 'brand_left', 1, 30, '1', 'grakan-light', NULL, NULL),
	('9aaaab35-9d15-4ffa-962b-3fa3ef8ff658', 'Product last view (grakan-light)', 'left', '*', 'view', 'product_lastview_left', 1, 40, '1', 'grakan-light', NULL, NULL),
	('9aaaab35-9d26-4b35-be34-5771a51e2e14', 'Product special (grakan-light)', 'left', '*', 'view', 'product_special_left', 1, 30, '1', 'grakan-light', NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_store_block` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_store_css
CREATE TABLE IF NOT EXISTS `gc_shop_store_css` (
  `css` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `template` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  UNIQUE KEY `gc_shop_store_css_store_id_template_unique` (`store_id`,`template`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_store_css: ~1 rows (approximately)
DELETE FROM `gc_shop_store_css`;
/*!40000 ALTER TABLE `gc_shop_store_css` DISABLE KEYS */;
INSERT INTO `gc_shop_store_css` (`css`, `store_id`, `template`, `created_at`, `updated_at`) VALUES
	('####CSS HERE ######', '1', 'grakan-light', NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_store_css` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_subscribe
CREATE TABLE IF NOT EXISTS `gc_shop_subscribe` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_subscribe_email_index` (`email`),
  KEY `gc_shop_subscribe_store_id_index` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_subscribe: ~0 rows (approximately)
DELETE FROM `gc_shop_subscribe`;
/*!40000 ALTER TABLE `gc_shop_subscribe` DISABLE KEYS */;
/*!40000 ALTER TABLE `gc_shop_subscribe` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_supplier
CREATE TABLE IF NOT EXISTS `gc_shop_supplier` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alias` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `gc_shop_supplier_alias_index` (`alias`),
  KEY `gc_shop_supplier_store_id_index` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_supplier: ~2 rows (approximately)
DELETE FROM `gc_shop_supplier`;
/*!40000 ALTER TABLE `gc_shop_supplier` DISABLE KEYS */;
INSERT INTO `gc_shop_supplier` (`id`, `name`, `alias`, `email`, `phone`, `image`, `address`, `url`, `status`, `store_id`, `sort`, `created_at`, `updated_at`) VALUES
	('9aaaab37-7f80-43df-a8ad-abc48a388d95', 'Supplier ABC', 'supplier-abc', 'abc@gmail.com', '0123456789', '/data/supplier/supplier.jpg', NULL, NULL, 1, '1', 0, NULL, NULL),
	('9aaaab37-7f88-40f5-ba7a-670856402143', 'Supplier XYZ', 'supplier-xyz', 'xyz@gmail.com', '0987654321', '/data/supplier/supplier.jpg', NULL, NULL, 1, '1', 0, NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_supplier` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_tax
CREATE TABLE IF NOT EXISTS `gc_shop_tax` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table grakan.gc_shop_tax: ~1 rows (approximately)
DELETE FROM `gc_shop_tax`;
/*!40000 ALTER TABLE `gc_shop_tax` DISABLE KEYS */;
INSERT INTO `gc_shop_tax` (`id`, `name`, `value`, `created_at`, `updated_at`) VALUES
	(1, 'Tax default (10%)', 10, NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_tax` ENABLE KEYS */;

-- Dumping structure for table grakan.gc_shop_weight
CREATE TABLE IF NOT EXISTS `gc_shop_weight` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gc_shop_weight_name_unique` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table grakan.gc_shop_weight: ~4 rows (approximately)
DELETE FROM `gc_shop_weight`;
/*!40000 ALTER TABLE `gc_shop_weight` DISABLE KEYS */;
INSERT INTO `gc_shop_weight` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES
	(1, 'g', 'Gram', NULL, NULL),
	(2, 'kg', 'Kilogram', NULL, NULL),
	(3, 'lb', 'Pound ', NULL, NULL),
	(4, 'oz', 'Ounce ', NULL, NULL);
/*!40000 ALTER TABLE `gc_shop_weight` ENABLE KEYS */;
