...
if (!function_exists('gc_product_admin_select_list') && !in_array('gc_get_plugin_captcha_installed', config('helper_except', []))) {
    /**
     ...
     */
    function gc_product_admin_select_list(array $dataFilter = [], $storeId = null)
    {
