...
class ShopCurrency extends Model
{
    ...
    public $table = GC_DB_PREFIX.'shop_currency';
    ...
    public static function sumCartCheckout(float $rate = null)
    {
        ...
        foreach ($dataCheckout as $item) {
            ...
            $sumValueWithTax = $item->qty * self::getValue(gc_tax_price($item->price, $item->tax), $rate);
    ...
    protected static function boot()
    {
        ...
        static::deleting(function ($model) {
            if (in_array($model->id, GC_GUARD_CURRENCY)) {
                return false;
            }
        });
    }
