...
class AppConfig extends ConfigDefault
{
    ...
    public function install()
    {
        ...
        if ($check) {
            ...
            $return = ['error' => 1, 'msg' =>  gc_language_render('admin.plugin.plugin_exist')];
        } else {
            ...
            Detail: https://grakan.org/docs/master/create-new-a-plugin.html 
            */
            ...
            // );
            if (!$process) {
                $return = ['error' => 1, 'msg' => gc_language_render('admin.plugin.install_faild')];
            } else {
    ...
    public function uninstall()
    {
        ...
        $process = (new AdminConfig)
            ...
            ->delete();
        if (!$process) {
            $return = ['error' => 1, 'msg' => gc_language_render('admin.plugin.action_error', ['action' => 'Uninstall'])];
        }
