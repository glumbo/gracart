...
<section class="section swiper-container swiper-slider swiper-slider-1" data-loop="true" data-autoplay="5000">
  <div class="swiper-wrapper text-center text-lg-left">
    ...
    <div class="swiper-slide swiper-slide-caption context-dark" data-slide-bg="{{ gc_file($banner->image) }}">
      <div class="swiper-slide-caption section-md text-center">
        <div class="container">
          <a href="{{ gc_route('banner.click',['id' => $banner->id]) }}" target="{{ $banner->target }}">
            {!! gc_html_render($banner->html) !!}
          </a>
        </div>
      </div>
    </div>
